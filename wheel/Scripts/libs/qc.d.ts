...
declare module qc {
    ...
    export class Color {
        constructor(
            rgb: number | string | [number, number, number] | [number, number, number, number]
        );
    ...
    export class Node {
        ...
        setPropertyIgnoreLayout(param: { prop: string, value?: unknown }): any;
         ...
         */
        removeScript(script: qc.Behaviour): void;
        /**
        ...
        /**
         * 添加组件，同addScript,还未修改成按类型添加
         * @param script 组件类或类名
         */
        addComponent(script: string): any;
        /**
         * 移除组件，同removeScript
         * @param script 组件类或类名
         */
        removeComponent(script: string): any;
        /**
         * 获取组件，同getScript
         * @param script 组件类或类名
         */
    ...
    export class Dom extends Node {
         ...
         * The pos of node
         */
        static POS_NONE: number;
        static POS_BACK: number;
        static POS_FRONT: number;
     ...
     */
    export function defineBehaviour(
        clazz: string,
        inheritFrom: any,
        init: Function,
        serializable: Object
    ...
    export class FilterGroup extends Behaviour {
        addFilter(blur: any): any;
        findFilter(BlurY: typeof Phaser.Filter): any;
    }

    export class Filter extends Phaser.Filter {
        static Highlight: typeof Filter;
    }
