...
(function (ps) {
    ...
    var EventDispatcher = /** @class */ (function () {
        ...
        EventDispatcher.prototype.event = function (type) {
            ...
            return this.dispatch.apply(this, __spreadArray([type], __read(params), false));
        };
        /**
         * 派发事件。(同Event)
         * @param type	事件类型。
        ...
        EventDispatcher.prototype.dispatch = function (type) {
            ...
            var singal = this.getSingal(type, false);
            if (singal)
                singal.dispatch.apply(singal, __spreadArray([], __read(params), false));
            //
            var singalAll = this.getSingal(EventDispatcher.ALL, false);
            if (singalAll)
                singalAll.dispatch.apply(singalAll, __spreadArray([type], __read(params), false));
        };
        /**
         * 获取指定类型的侦听器
         * @param type 	事件类型。
