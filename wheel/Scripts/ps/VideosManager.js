    ...
    var VideosManager = /** @class */ (function (_super) {
        ...
        VideosManager.prototype.awake = function () {
            ...
            if (this.videoType === "ts") {
                if (this.gameObject.children[0] && !ps.Tools.objIsNull(this.mapVideoNodes)) {
                ...
                if (!ps.Tools.objIsNull(this.mapVideoNodes)) {
                    ...
                    ps.Print.green("当前无视频节点，自动触发 gameReady");
                    this.gameReady();
                }
            }
        };
...
//# sourceMappingURL=VideosManager.js.map