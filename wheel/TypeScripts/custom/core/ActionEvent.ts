...
type Action<P1 = Never, P2 = Never, P3 = Never, P4 = Never, P5 = Never, P6 = Never, P7 = Never, P8 = Never, P9 = Never> = {
    (...args: ActionArgs<P1, P2, P3, P4, P5, P6, P7, P8, P9>): void;
}

type Func<R = void, P1 = Never, P2 = Never, P3 = Never, P4 = Never, P5 = Never, P6 = Never, P7 = Never, P8 = Never, P9 = Never> = {
 ...
 */
class ActionEvent<P1 = Never, P2 = Never, P3 = Never, P4 = Never, P5 = Never, P6 = Never, P7 = Never, P8 = Never, P9 = Never> {
