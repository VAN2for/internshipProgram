    ...
    var NumScroll = /** @class */ (function (_super) {
        ...
        function NumScroll(gameObject) {
            ...
            _this.serializableFields = {
                ...
                prefixPosition: qc.Serializer.STRING,
        ...
        NumScroll.prototype.awake = function () {
            this.curNum = Number(ps.Mathf.keepDecimal(this.curNum, this.roundCnt));
            this.gameObject.text = this.prefixPosition === "后" ? ps.Tools.switchNum(this.curNum, this.isComma, void 0, void 0, this.roundCnt) + this.prefix : this.prefix + ps.Tools.switchNum(this.curNum, this.isComma, void 0, void 0, this.roundCnt);
        };
        ...
        NumScroll.prototype.playNum = function () {
            ...
            var change = function (random) {
                ...
                var changeUnit = Number(ps.Mathf.keepDecimal(diffNum / changeTimes, _this.roundCnt)); //每次变化的值
                //依次变化
                var i = 0;
        ...
        NumScroll.prototype.updateRender = function (num) {
            ...
            this.gameObject.text = this.prefixPosition === "后" ? ps.Tools.switchNum(num, this.isComma, void 0, void 0, this.roundCnt) + this.prefix : this.prefix + ps.Tools.switchNum(num, this.isComma, void 0, void 0, this.roundCnt);
        };
        return NumScroll;
    }(ps.Behaviour));
