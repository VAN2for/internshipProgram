...
(function (ps) {
    ...
    var ListScroll = /** @class */ (function (_super) {
        ...
        ListScroll.prototype.awake = function (resetToEnd /*  ps.ENV === 'EDITOR' */) {
            ...
            this.whBack = this.listLayout === ListLayout.HORIZONTAL ? "height" : "width";
        ...
        ListScroll.prototype.renderList = function () {
            ...
            for (var i = 0; i < this.textureIdxs.length; i++) {
                ...
                var img = this.listBox0.getChildAt(i) || new qc.UIImage(this.game, this.listBox0);
                img.texture = texture;
                img.resetNativeSize();
                ...
                nextImgXY = img["anchored" + this.xy.toUpperCase()] + (img[this.wh] + space) * -this.direScroll;
                if (i === this.stopToIdx)
                    this.stopToXY = img[this.xy];
                this.listBox0[this.wh] += img[this.wh] + addSpace;
                this.listBox0[this.whBack] = Math.max(this.listBox0[this.whBack], img[this.whBack]);
            }
        ...
        ListScroll.prototype.cloneListBox = function (listBox) {
            ...
            this.listBox1[this.xy] = listBox[this.xy] + this.space + listBox[this.wh] * -this.direScroll;
        };
        ...
        ListScroll.prototype.initTw0 = function (resetFrom) {
            ...
            tw0.moveAxis = this.xy === "x" ? qc.TweenPosition.ONLY_X : qc.TweenPosition.ONLY_Y;
            tw0.from[this.xy] = resetFrom ? this.orgXY : this.gameObject[this.xy];
            tw0.from[this.xyBack] = resetFrom ? this.orgXYBack : this.gameObject[this.xyBack];
            tw0.to[this.xy] = tw0.from[this.xy] + this.gameObject[this.wh] * this.direScroll;
        ...
        ListScroll.prototype.initTw1 = function (resetFrom) {
            ...
            tw1.moveAxis = this.xy === "x" ? qc.TweenPosition.ONLY_X : qc.TweenPosition.ONLY_Y;
            tw1.from[this.xy] = resetFrom ? this.orgXY : this.gameObject[this.xy];
            tw1.from[this.xyBack] = resetFrom ? this.orgXYBack : this.gameObject[this.xyBack];
            ...
            tw1.duration = this.duration * base;
        };
