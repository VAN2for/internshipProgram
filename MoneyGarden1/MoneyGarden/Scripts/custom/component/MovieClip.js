...
(function (ps) {
    ...
    var MovieClip = /** @class */ (function (_super) {
        ...
        function MovieClip(gameObject) {
            ...
            _this.actionNames = { framename: "1" };
            _this.defActionName = "framename";
            _this.defPlay = false;
            _this.defLoop = false;
            _this.backplay = false;
            ...
            _this.serializableFields = {
                ...
                backplay: qc.Serializer.BOOLEAN,
        ...
        MovieClip.prototype.awake = function () {
            ...
            if (this.defPlay && this.mcData[this.defActionName]) {
                this.gotoAndPlay(this.defActionName, this.defLoop ? -1 : 1, undefined, undefined, this.backplay);
            }
        ...
        MovieClip.prototype.dispatch = function () {
            ...
            this.callback = null;
            this.context = null;
            if (this.autoDestory && ps.ENV != "EDITOR") {
        ...
        MovieClip.prototype.updateFrame = function () {
            ...
            if (this.frameIndex > this.currentData.frameCnt) {
                ...
                else if (!this.currentData.backplay) {
