        ...
        Layout.setLayout = function (obj, key, value) {
            ...
            switch (key) {
                ...
                case "centerX":
                    if (obj.parent)
                        obj.x =
                            (obj.parent.width - realWidth) / 2 + offsetX - offsetParentX + value;
                    break;
                case "centerY":
                    if (obj.parent)
                        obj.y =
                            (obj.parent.height - realHeight) / 2 + offsetY - offsetParentY + value;
                    break;
                case "percX":
                    if (obj.parent)
                ...
                case "rotation":
                    ...
                    break;
                case "width":
                    obj.width = Math.max(value, 0);
                    break;
                case "height":
                    obj.height = Math.max(value, 0);
                    break;
                case "alpha":
                    obj.alpha = Math.min(Math.max(value, 0), 1);
                    break;
                case "visible":
                    obj.visible = bol;
                    break;
