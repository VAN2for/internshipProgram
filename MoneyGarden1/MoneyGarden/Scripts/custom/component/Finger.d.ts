declare namespace ps {
    ...
    class Finger extends ps.Behaviour {
         ...
         * @param delay 延迟播放时间
         */
        show(resetScale?: boolean, delay?: number): void;
        /** 隐藏 */
        hide(): void;
        /**
         * 设置手指缩放值
         ...
         * @param duration 持续时间
         */
        tweenTo(props: any, duration: number, easing?: typeof Phaser.Easing.Sinusoidal.InOut): this;
        /**
         * 清理缓动
         */
        clearTweener(clearCB?: boolean): this;
        /**
         * 开始流程
         * @param cb
         */
