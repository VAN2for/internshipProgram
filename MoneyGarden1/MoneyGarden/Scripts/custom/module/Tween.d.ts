declare namespace ps {
    ...
    class Tween {
         ...
         * @param target 目标对象。如传入组件，则目标对象为组件的gameObject
         */
        static clearAll(target: any, isBehaviour?: boolean): void;
        /**
         * 渐现
         * @param target 目标对象。如传入组件，则目标对象为组件的gameObject
         ...
         * @param delay 延迟执行时间
         */
        static shakeRotation(target: any, times?: number, value?: number, duration?: number, delay?: number): Phaser.Tween;
    }
}
