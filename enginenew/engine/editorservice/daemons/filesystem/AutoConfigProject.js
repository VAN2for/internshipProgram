...
function _initConfig(gameRoot) {
    ...
    G.config.systemPredefined = [
        ...
        FS_EXPAND_D.toUnixFileName(gameRoot + 'resource/'),
        FS_EXPAND_D.toUnixFileName(gameRoot + 'resource/raw/'),
        FS_EXPAND_D.toUnixFileName(gameRoot + 'resource/scene/'),
        FS_EXPAND_D.toUnixFileName(gameRoot + 'resource/css/'),
    ...
    var defaultProjectSetting = {
        ...
        android: {
            ...
            splashImage: {
                ...
                url: "resource/sprites/loading.bin",
                frame: "other/zhu2"
            },
            minTarget: 16,
            buildCode: 1,
    ...
    if (!G.config.project.useLanguages) {
        G.config.project.useLanguages = defaultProjectSetting.useLanguages;
    }
    ...
    // 创建css目录
    var cssPath = gameRoot + 'resource/css/style.css';
    fsExtra.ensureDirSync(gameRoot + 'resource/css');
