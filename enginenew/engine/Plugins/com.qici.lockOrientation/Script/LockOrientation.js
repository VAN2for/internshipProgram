...
// 初始化处理，关注横竖版事件并做处理
LockOrientation.prototype.onEnable = function () {
    var self = this;
    self._doOrientation();
};
...
LockOrientation.prototype._doOrientation = function () {
    ...
    ps.ScrFix.width = o.width;
    ps.ScrFix.height = o.height;

    if (!self.desktop && !self.game.editor && self.game.device.desktop || !this.enable) {
        o.rotation = 0;
        self.rotate90 = false;
        return;
    }
