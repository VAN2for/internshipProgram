    ...
    if (!a.qc || !a.qc.widget) {
        ...
        k.view = function(f) {
            ...
            f.setDisabled = function(a, b) {
                var c = this
                  , d = c._disabled;
                d !== a && (d && (oa(c._disabledDiv),
                delete c._disabledDiv),
                a && (na(c._view, c._disabledDiv = ta(b)),
                c.iv()),
                c._disabled = a,
                c.epc("disabled", d, a))
            }
            ...
            f.dispose = function() {
                var b = this
                  , d = b._resizeHandler;
                d && (a.removeEventListener("orientationchange", d, !1),
                a.removeEventListener("resize", d, !1),
                b._resizeHandler = c),
                oa(b.view)
            }
            ,
            ...
            f.iv = function(a) {
                var b = this;
                a && (b._forceLayout = !0),
                b._invalidate || (b._invalidate = !0,
                qb(b.validate, b))
            }
            ,
            f.checkChildPreferredSizeChange = function(a, d) {
                var e, f = this, g = !1, h = function() {
                ...
                if (g && (f._calcdPreferredSize = f._calcdPreferredSizeMap = c),
                f.parent && j)
                    if (i)
            ...
            f.validate = function() {
                ...
                if (a._invalidate) {
                    ...
                    f && (b.lastChild !== f && (oa(f),
                    na(b, f)),
                    f.style.backgroundColor = a.disabledBackground || j.disabledBackground,
                    sa(f, 0, 0, d, e)),
                    Ja(a),
            ...
            z(f, {
                ...
                width: {
                    ...
                    set: function(a) {
                        ...
                        b.epc("width", c, a),
                        c !== a && (b.iv(),
                        b.endEditing && !F && b.endEditing(),
                        b.redraw && b.redraw(),
                        b.showScrollBar && b.showScrollBar())
                    }
                },
                height: {
                    get: function() {
        ...
        k.interactor = function() {
            var a = function(a, b) {
                ...
                b[c] || (b[c] = d,
                b.view.addEventListener(a, d, !1))
            }
              , b = function(a, b) {
                var c = "__" + a
                  , d = b[c];
                d && (b.view.removeEventListener(a, d, !1),
                delete b[c])
            };
            return function(c) {
            ...
            function q(a) {
                ...
                function l(a, b, c, d, e, f) {
                    ...
                    if (!t._callbacks[a])
                        return [];
                    for ("keyup" == l && k(a) && (b = [a]),
                    h = 0; h < t._callbacks[a].length; ++h)
                        if (i = t._callbacks[a][h],
                        (d || !i.seq || x[i.seq] == i.level) && l == i.action && ("keypress" == l && !c.metaKey && !c.ctrlKey || g(b, i.modifiers))) {
                            var m = !d && i.combo == e
                ...
                function m(a, b, c, d) {
                    t.stopCallback(b, b.target || b.srcElement, c, d) || a(b, c) === !1 && (i(b),
                    j(b))
                }
                function n(a) {
                ...
                function s(a, b, c, d, e) {
                    ...
                    a = a.replace(/\s+/g, " ");
                    var f, g = a.split(" ");
                    return g.length > 1 ? void r(a, g, b, c) : (f = o(a, c),
                    t._callbacks[f.key] = t._callbacks[f.key] || [],
                    l(f.key, f.modifiers, {
                        type: f.action
                    }, d, a, e),
                    void t._callbacks[f.key][d ? "unshift" : "push"]({
                        callback: b,
        ...
        var T = function(a, b) {
          ...
          , fa = function(a) {
            ...
            ("DIV" === b || "CANVAS" === b) && ("keydown" !== a.type || Xa(a) || Za(a) || Ya(a) || $a(a) || Sa(a) || 65 === a.keyCode && (a.metaKey || a.ctrlKey)) && (a.preventDefault(),
          ...
          , sa = function(a, b, d, f, g, h) {
            if (a) {
                ...
                var i = ra(a)
                  , j = i.style;
                (e.fullscreenElement || e.mozFullScreenElement || e.webkitFullscreenElement || e.msFullscreenElement) !== i && (b = n(b),
                d = n(d),
                f = n(f),
                g = n(g),
                b != c && (j.left = b + J),
                d != c && (j.top = d + J),
                f != c && (0 > f && (f = 0),
                a.tagName ? j.width = f + J : a.width = f),
                g != c && (0 > g && (g = 0),
                a.tagName ? j.height = g + J : a.height = g)),
                h && a.iv && a.iv(!0),
          ...
          , ta = function(a) {
            ...
            c.backgroundPosition = "50% 50%",
            c.backgroundRepeat = "no-repeat no-repeat"),
            c.zIndex = "10000",
            b
        }
          , ua = function(a) {
          ...
          , xa = function(a, b, c, d, e, f) {
            ...
            if (1 === g)
                ...
                for (var h = c.height / g, i = {
                    ...
                    f ? Aa(a, b[j], d, e, i.x, i.y, i.width, i.height, f) : ya(a, b[j], i, d, e),
                    i.y += h
        }
          , ya = function(a, b, c, e, f) {
            ...
            var h, i;
            c ? c.width === d ? (h = c.x,
            i = c.y) : (h = c.x + c.width / 2,
            i = c.y + c.height / 2) : (h = 0,
            i = 0),
          ...
          , za = function() {
            ...
            return function(d, e) {
                ...
                var f = a[b.font];
                return f || (f = 2 * b.measureText("e").width + 4,
                a[b.font] = f),
                {
          ...
          , Aa = function(a, b, d, e, f, g, h, i, j, k) {
            if (b != c) {
                var l, m = {};
                k && "middle" !== k ? "top" === k ? (l || (l = za(d, b)),
                m.y = g + l.height / 2) : (l || (l = za(d, b)),
                m.y = g + i - l.height / 2) : m.y = g + i / 2,
                j && "left" !== j ? "right" === j ? (l || (l = za(d, b)),
                m.x = f + h - l.width / 2) : m.x = f + h / 2 : (l || (l = za(d, b)),
                m.x = f + l.width / 2),
                ya(a, b, m, d, e)
            }
        }
          ...
          , Ia = c
          , Ja = function(a) {
            Ha && !a._loadingView_ && (Ia || (Ia = {}),
            Ia[a._loadingView_ = N()] = a)
        }
          , Ka = function(b, d, e, f) {
            Ha || (Ha = {});
            var h = Ha[b];
          ...
          , Na = function(a, b) {
            ...
            if (a == c)
                return c;
            if (W(a) ? e = a : (e = h[a],
            a && e === d && (Ha && Ha[a] || Ka(a, a))),
            b && e && e.tagName) {
                e.colors || (e.colors = {});
                var f = e.colors[b];
                return f || (f = Ga(e, b, e.width, e.height),
                e.colors[b] = f),
                f
            }
            return e
        ...
        a.addEventListener && (a.addEventListener("keyup", function(a) {
            91 === a.keyCode ? Oa = {} : delete Oa[a.keyCode]
        }, !0),
        ...
        var ib = c
          ...
          , ob = function(b, c) {
            b !== ib && (ib ? Pa(c) ? ib.handleWindowMouseUp(c) : ib.handleWindowTouchEnd(c) : Pa(c) ? (a.addEventListener("mousemove", mb, !1),
            a.addEventListener("mouseup", nb, !1)) : (a.addEventListener("touchmove", kb, !1),
            a.addEventListener("touchend", lb, !1)),
            ib = b)
        };
        !function() {
            ...
            return function(b) {
                ...
                b.tick = function() {
                    if (b.duration) {
                        ...
                        b.action(b.easing(a), a),
                        b.frame < b.frames ? b._isPaused || (b.timeId = qb(b.tick, c, c, b.interval)) : b.stop()
                }
                ,
                b.resume = function() {
                    b._isPaused && (delete b._isPaused,
                    b.duration ? b.t < 1 && (b.startTime = sb() - b.duration * b.t,
                    b.timeId = qb(b.tick)) : b.frame < b.frames && (b.timeId = qb(b.tick, c, c, b.interval)))
                }
                ,
                b.pause = function() {
                    b._isPaused = !0
                ...
                b.stop = function(a) {
                    ...
                    b.action(b.easing(1))),
                    b.innerFunc && b.innerFunc(),
                    b.finishFunc && b.finishFunc(),
                    rb(b.timeId, !b.duration),
                    delete b.timeId)
                }
                ,
...
function(a, b, c, d) {
    ...
    }, !0);
    {
        ...
        w.lineJoin)
          ...
          , la = w.imageGradient
          , ma = (w.zoomIncrement,
        w.scrollZoomIncrement,
        w.pinchZoomIncrement,
        w.maxZoom,
        w.minZoom,
        w.toolTipDelay,
        w.toolTipContinuous,
        ...
        w.toolTipLabelColor,
        w.toolTipBackground,
        w.toolTipShadowColor,
        w.scrollBarColor,
        w.scrollBarSize,
        w.scrollBarTimeout,
        w.scrollBarMinLength,
        w.scrollBarActiveSize,
        w.closePopup,
        w.hideToolTip)
          , na = w.showToolTip
          , oa = w.callLater
        ...
        w.createDiv)
          ...
          , hb = w.intersectsRect
          , ib = w.intersection
          , jb = (w.intersectionLineRect,
        w.intersectionLineLine,
        w.getRotationRect)
          ...
          , Ub = function(a, b, c, d, e, f) {
            ...
            g.clip(),
            g.clearRect(e.x, e.y, e.width, e.height)),
            g
        }
          , Vb = function(a, b, c) {
            return b && a.setLineDash ? (a.setLineDash(b),
            c && (a.lineDashOffset = c),
            a) : void 0
        }
          , Wb = function(a, b) {
            b && a.setLineDash && (a.setLineDash(pa),
            a.lineDashOffset = 0)
        }
          , Xb = function(a, b, c) {
            a.translate(b, c)
          ...
          , da = function(a, b, d, e, f, g, i, j, k, l, n) {
            if (Pa(b) && (b = ca(b, l)),
            b != c) {
                var o, p = ac(b, j, k), q = bc(b, j, k);
                if ("uniform" === d ? (o = m(g / p, i / q),
                p *= o,
                q *= o,
                e += h((g - p) / 2),
                f += h((i - q) / 2),
                g = p,
                i = q) : ("centerUniform" === d || d == c) && ((p > g || q > i) && (o = m(g / p, i / q),
                p *= o,
                q *= o),
                e += h((g - p) / 2),
                f += h((i - q) / 2),
          ...
          , tb = function(a, b, c, d, e, f, g, i) {
            ...
            a.fillStyle = b,
            a.beginPath(),
            i.left && a.rect(c, d, g, f),
            i.top && a.rect(c, d, e, g),
            i.bottom && a.rect(c, d + f - g, e, g),
            i.right && a.rect(c + e - g, d, g, f),
            a.fill())
        }
          , xb = function(a, b, c, d) {
            var e, f, g, h = nb(b), i = d, k = h[0], l = h[1], n = h[2];
            if (c) {
                var o = nb(c);
                e = o[0] - k,
                f = o[1] - l,
          ...
          , yb = function(a, b, c, d) {
            ...
            c && c.length) {
                for (var e, f, g, h, i = 0, j = 0, k = c.length; k > j; j++)
                    e = c[j],
                    1 === e ? (f = b[i++],
                    a.moveTo(f.x, f.y)) : 2 === e ? (f = b[i++],
                    a.lineTo(f.x, f.y)) : 3 === e ? (f = b[i++],
                    g = b[i++],
                    a.quadraticCurveTo(f.x, f.y, g.x, g.y)) : 4 === e ? (f = b[i++],
                    g = b[i++],
                    h = b[i++],
                    a.bezierCurveTo(f.x, f.y, g.x, g.y, h.x, h.y)) : 5 === e && a.closePath();
                d && 5 !== e && a.closePath()
            } else {
                var l, m, n, o = b.length;
                if (o > 0) {
                    for (l = b[0],
                    a.moveTo(l.x, l.y),
                    m = 1; o > m; m++)
          ...
          , cc = function(a, b, e) {
            if (!a || !a.func)
                return Fa(a);
            var f, g = a.func, h = a.value;
            return Ta(g) ? f = g(b, e) : b ? $b.test(g) ? f = b.s(g.slice(6)) : _b.test(g) ? f = b.a(g.slice(5)) : (f = b[g],
            Ta(f) && (f = f(e))) : f = h,
            h !== d && f == c ? h : f
        }
          , dc = function(a, b, c, d) {
                ...
                if (g) {
                    if (!g._rect_) {
                        for (var h = cc(b.relative, e, f), i = ec(b, d, e, f), j = [], k = g.length, l = 0; k > l; l += 2) {
                            ...
                            h && (m *= d.width,
                            n *= d.height),
                            i && (m = m * i.width / d.width + i.x,
                            n = n * i.height / d.height + i.y),
                            j.push({
                                x: m,
                                y: n
                            })
          ...
          , ic = function(a, b, d, e, f, g) {
            ...
            if (D) {
                if (p) {
                    ...
                    m && a.scale(m[0], m[1]),
                    Xb(a, -E.x, -E.y),
                    o && (Ta(o) ? o(a, D, d, e, b) : (a.beginPath(),
          ...
          , jc = function(a, b, d, e, f, g, h, i, j) {
            if (!(!b || 0 >= f || 0 >= g)) {
                ...
                if (cc(b.visible, h, i) !== !1) {
                    ...
                    n && (Ta(n) ? n(a, m, h, i, b) : (a.beginPath(),
                    a.rect(0, 0, k, l),
                    a.clip())),
                    o != c && (a.globalAlpha *= o),
                    cc(b.comps, h, i).forEach(function(b) {
                        cc(b.visible, h, i) !== !1 && (Zb.splice(0, 0, b),
                        ic(a, b, h, i, j, m),
                        Zb.splice(0, 1))
                    }),
                    a.restore()
        ...
        e.widget.Tween = function(b) {
            ...
            this.update = function(a) {
                ...
                for (b in f) {
                    var v = e[b] || 0
                      , w = f[b];
                    w instanceof Array ? c[b] = p(w, k) : ("string" == typeof w && (w = v + parseFloat(w, 10)),
                    "number" == typeof w && (c[b] = v + (w - v) * k))
                }
                if (null !== t && t.call(c, k),
                1 == d) {
                    if (i > 0) {
                        isFinite(i) && i--;
                        for (b in g) {
                            if ("string" == typeof f[b] && (g[b] = g[b] + parseFloat(f[b], 10)),
                            j) {
                                var x = g[b];
                                g[b] = f[b],
                                f[b] = x
    ...
    kc.Interpolation = {
        ...
        Bezier: function(a, b) {
            var c, d = 0, e = a.length - 1, f = Math.pow, g = kc.Interpolation.Utils.Bernstein;
            for (c = 0; e >= c; c++)
    ...
    var yc = {
      ...
      , na = function(a, b) {
        ...
        Fc || (Fc = ra(),
        Gc = ra(),
        Fc.className = "qc-widget-tooltip",
        e = Fc.style,
        e.cursor = "default",
        e.whiteSpace = "nowrap",
        e.color = w.toolTipLabelColor,
        e.background = w.toolTipBackground,
        e.font = w.toolTipLabelFont,
        e.padding = w.toolTipPadding + f,
        e.boxShadow = "0px 0px 3px " + w.toolTipShadowColor),
        b.html ? (b = b.html,
        d = Gc,
        Ba(Fc)) : (d = Fc,
        Ba(Gc)),
    ...
    a.addEventListener && (a.addEventListener("mouseout", function(a) {
        ...
        (!b || Hc && !Hc.view.contains(b)) && (Ic(),
        ma())
    }, !1),
    a.addEventListener(ia, function() {
        Ic(),
        ma()
    }, !1));
    ...
    z.emitter = function(a) {
        ...
        a.off = function(a, b, c) {
            var d = this;
            return d._emitter && d._emitter.off(a, b, c),
            d
        }
        ,
        a.emit = function(a, b) {
            var c = this;
            return c._emitter && c._emitter.emit(a, b),
            c
        }
        ,
        ...
        a.epc = function(a, b, c) {
            ...
            return this.emit("propertyChange", d),
            this.onPropertyChange(d),
            d
        }
    }
    ,
            ...
            selectionModelShared: {
                ...
                set: function(a) {
                    var b = this
                      ...
                      , f = b.dataModel;
                    d !== a && (b.invalidateSelection && b.invalidateSelection(),
                    a ? (f.selectionModel.on("selectionChange", e, b),
                    b._selectionModel.off("selectionChange", e, b),
                    b._selectionModel.dispose(),
                    b._selectionModel = c) : (f.selectionModel.off("selectionChange", e, b),
                    b._selectionModel = new Rc(f),
                    b._selectionModel.on("selectionChange", e, b)),
                    b.invalidateSelection && b.invalidateSelection(),
                    b.redraw && b.redraw(),
                    b.epc("selectionModelShared", d, a))
                }
            }
        })
    }
    ...
    z.painter = function(a) {
        a.addTopPainter = function(a) {
            ...
            b._topPainters.indexOf(a) < 0 && (b._topPainters.push(a),
            b.redraw ? b.redraw() : b.iv())
        }
        ,
        a.removeTopPainter = function(a) {
            var b = this;
            b._topPainters && (Va(b._topPainters, a),
            b.redraw ? b.redraw() : b.iv())
        }
        ,
        a.addBottomPainter = function(a) {
            ...
            b._bottomPainters.indexOf(a) < 0 && (b._bottomPainters.push(a),
            b.redraw ? b.redraw() : b.iv())
        }
        ,
        a.removeBottomPainter = function(a) {
            var b = this;
            b._bottomPainters && (Va(b._bottomPainters, a),
            b.redraw ? b.redraw() : b.iv())
        }
        ,
    ...
    z.toolTip = function(a) {
        ...
        a.enableToolTip = function() {
            ...
            a._handleToolTip || (a._handleToolTip = function(b) {
                ...
                if (!(2 > h)) {
                    ...
                    i != c ? a.toolTipContinuous && Kc() ? na(b, i) : (ma(),
                    Hc = {
        ...
        a.disableToolTip = function() {
            var a = this;
            a._handleToolTip && (a.removeEventListener("mousemove", a._handleToolTip, !1),
            delete a._handleToolTip)
        }
        ,
    ...
    z.scrollBar = function(a) {
        ...
        a.autoScroll = function(a, b) {
            ...
            return d > 0 && (h.x - g.x < e ? c.translate(f, 0) : g.x + g.width - h.x < e && c.translate(-f, 0),
        ...
        a.handleVScrollBarTimeout = function() {
            ...
            if (a._vScrollBarTimer) {
                var b = new Date;
                b.getTime() - a._vScrollBarTimer.getTime() >= a.scrollBarTimeout ? (delete a._vScrollBarTimer,
                a.iv()) : v(function() {
                    a.handleVScrollBarTimeout()
                }, a.scrollBarTimeout)
            }
        ...
        a.validateVScrollBar = function() {
            ...
            if (a._scrollBarDiv) {
                ...
                n.background = a.scrollBarColor,
                n.borderRadius = d / 2 + f) : n.visibility = "hidden"
            }
        }
        ,
        ...
        a.handleHScrollBarTimeout = function() {
            ...
            if (a._hScrollBarTimer) {
                var b = new Date;
                b.getTime() - a._hScrollBarTimer.getTime() >= a.scrollBarTimeout ? (delete a._hScrollBarTimer,
                a.iv()) : v(function() {
                    a.handleHScrollBarTimeout()
                }, a.scrollBarTimeout)
            }
        ...
        aa(a, {
            scrollBarMode: {
                ...
                set: function(a) {
                    var b = this
                      , c = b._scrollBarMode;
                    c !== a && (b._scrollBarMode = a,
                    "off" === a ? (Ba(b._scrollBarDiv),
                    delete b._scrollBarDiv,
                    delete b._vScrollBar,
                    delete b._hScrollBar) : b._scrollBarDiv || (b._scrollBarDiv = ra(!1, b._interactionDiv),
                    b._vScrollBar = ra(!1, b._scrollBarDiv),
                    b._hScrollBar = ra(!1, b._scrollBarDiv)),
                    this.epc("scrollBarMode", c, a))
                }
            },
            translateX: {
                get: function() {
    ...
    z.element = function(a) {
        a.addElement = function(a, b, c, d, e) {
            if (a) {
                ...
                0 >= d || 0 >= e || (f._elements || (g = f._elements = []),
                wa(h, f.translateX + b, f.translateY + c, d, e),
                za(h, a),
                za(f._contentDiv, h),
                a.onAdd && a.onAdd(h),
                g.push(h))
        ...
        a.beginEditing = function(a, b, c, d, e, f) {
            ...
            if (h) {
                ...
                var i = g.getValue(a, b)
                  , j = h.getView();
                h.setValue(i),
                j && (za(g._editorDiv, va(j)),
                wa(j, c, !0),
                j.requestFocus ? j.requestFocus() : Aa(j),
                h.beginEditing(),
                g._currentEditor = h,
                g.iv())
            }
    ...
    z.list = function(a) {
        ...
        a.drawIcon = function(a, b, d, e, f, g) {
            if (f) {
                var h, i = this, h = i.getBodyColor(b), j = i.getIcon(b);
                j && (g -= i.rowLineVisible ? 1 : 0,
                da(a, j, c, d, e + 1, f, g - 2, b, i, h),
                tb(a, i.getBorderColor(b), d, e, f, g))
            }
        }
        ,
        ...
        a.checkData = function(a) {
            var b = this.selectionModel
              , c = b.isSelected(a);
            "single" === b.selectionMode && c || (this._checkingData = !0,
            c ? b.removeSelection(a) : b.appendSelection(a),
            delete this._checkingData)
        }
        ,
        ...
        ,
        a.ivm = function() {
            this._invalidateModel || (this._invalidateModel = !0,
            this.iv())
        }
        ,
        ...
        a.validateImpl = function() {
            ...
            a.drawTopPainters(h),
            h.restore(),
            a._makeVisibleData && (a.scrollToIndex(a.getRowIndex(a._makeVisibleData)),
            delete a._makeVisibleData),
            ...
            dataModel: {
                ...
                set: function(a) {
                    var b = this
                      , c = b._dataModel
                      , d = b._selectionModel;
                    c !== a && (c && (c.off("dataModelChange", b.handleDataModelChange, b),
                    c.off("dataPropertyChange", b.handleDataPropertyChange, b),
                    c.off("hierarchyChange", b.handleHierarchyChange, b),
                    d || c.selectionModel.off("selectionChange", b.handleSelectionChange, b)),
                    b._dataModel = a,
                    a.on("dataModelChange", b.handleDataModelChange, b),
                    a.on("dataPropertyChange", b.handleDataPropertyChange, b),
                    a.on("hierarchyChange", b.handleHierarchyChange, b),
                    d ? d._setDataModel(a) : a.selectionModel.on("selectionChange", b.handleSelectionChange, b),
                    b.epc("dataModel", c, a))
                }
            }
        })
    ...
    z.tree = function(a) {
        ...
        a.buildData = function(a) {
            var b = this
              , c = a.uuid
              , d = b._rows;
            b.isVisible(a) && (b._rowMap[c] = d.length,
            d.push(a),
        ...
        a.expand = function(a) {
            var b = this
              , d = b._loader;
            b.isExpanded(a) || (d && !d.isLoaded(a) && d.load(a),
            b._expandMap[a.uuid] = !0,
            b._calcdPreferredSize = b._calcdPreferredSizeMap = c,
            b.ivm(),
            b.validateModel(),
            b.onExpand(a),
        ...
        a.collapse = function(a) {
            var b = this;
            b.isExpanded(a) && (delete b._expandMap[a.uuid],
            b._calcdPreferredSize = b._calcdPreferredSizeMap = c,
            b.ivm(),
            b.validateModel(),
            b.onCollapse(a),
        ...
        a.expandAll = function(a) {
            var b = this;
            a ? a.length && (b._expandMap[a.uuid] = !0,
            a.children.forEach(function(a) {
                b.expandAll(a)
        ...
        a.collapseAll = function(a) {
            var b = this;
            a ? a.length && (delete b._expandMap[a.uuid],
            a.children.forEach(function(a) {
                b.collapseAll(a)
            })) : this._expandMap = {},
            b._calcdPreferredSize = b._calcdPreferredSizeMap = c,
        ...
        ,
        a.checkData = function(a) {
            var b, c = this, d = c._checkMode, e = c.selectionModel, f = e.isSelected(a);
            if ("single" !== e.selectionMode || !f) {
                if (c._checkingData = !0,
                "check" === d)
        ...
        a.drawTree = function(a, b, d, e, f, g) {
            var h = this
              ...
              , l = h.getToggleIcon(b);
            l ? (d += i * j,
            da(a, l, c, d, e, i, g, b, h),
            d += i) : d += i * (j + 1),
            h._checkMode && (da(a, h.getCheckIcon(b), c, d, e, i, g, b, h),
            d += i),
        ...
        a.drawData = function(a, b, c) {
            ...
            d._columnInfos.forEach(function(c) {
                var g = c.column
                  , h = c.beginX
                  , i = g.width;
                i > 0 && (d.drawCell(a, b, g, h, f, i, e),
                d._columnLineVisible && sb(a, h + i - 1, f, 1, e, d._columnLineColor))
            }),
            d._rowLineVisible && sb(a, h, f + e - 1, i, 1, d._rowLineColor)
        }
        ,
            ...
            if (Eb(b))
                for (var c = this, d = c.lp(b), e = c._columnInfos, f = c._rowHeight, g = c._viewRect, h = g.x, i = g.y, j = g.width, k = g.height, l = 0; l < e.length; l++) {
                    ...
                    if (o !== c._checkColumn && o !== c._treeColumn && c.isCellEditable(a, o) && d.x >= n && d.x < m.endX) {
                        ...
                        s && (c.translateX = c.translateX - s,
                        r.x -= s),
                        q.y < i ? t = q.y - i : q.y + f > i + k && (t = q.y + f - i - k),
                        t && (c.translateY = c.translateY - t,
                        r.y -= t),
    ...
    var Oc = _("qc.widget.Emitter", b, function() {}, {
        on: function(a, b, c, d) {
            ...
            do
                h--;
            while (h >= 0 && g[h].priority < d);return g.splice(h + 1, 0, {
                listener: b,
                scope: c,
                priority: d
            }),
      ...
      , Pc = _("qc.widget.Data", b, function(a) {
        ...
        addChild: function(a, b) {
            var c = this;
            if (a !== c && (c._children === pa && (c._children = [],
            c._childMap = {}),
            b === d && (b = c._children.length),
            !c._childMap[a.uuid] && !c.isDescendantOf(a)))
                return a._parent && a._parent.removeChild(a),
                (0 > b || b > c._children.length) && (b = this._children.length),
                c._children.splice(b, 0, a),
                c._childMap[a.uuid] = a,
                a.parent = this,
                c.onChildAdd(a, b),
                c.epc("children", d, a),
                c
      ...
      , Qc = _("qc.widget.DataModel", b, function() {
        ...
        remove: function(a) {
            if (a) {
                var b = this
                  , d = a.uuid;
                if (a._dataModel === b)
                    return b.prepareRemove(a),
                    Fa(a.children).forEach(b.remove, b),
                    a._parent && a._parent.removeChild(a),
                    Va(b._datas, a),
                    delete b._dataMap[d],
                    a.id != c && delete b._idMap[a.id],
                    b._rootMap[d] && (delete b._rootMap[d],
                    Va(b._roots, a)),
                    a._setDataModel(c),
                    b.onRemove(a),
                    b.emit("dataModelChange", {
                        kind: "remove",
                        data: a
                    }),
                    b
        ...
        handleDataPropertyChange: function(a) {
            ...
            if ("parent" === e) {
                var f = d.uuid
                  , g = b._rootMap;
                d._parent ? g[f] && (delete g[f],
                Va(b._roots, d)) : g[f] || (g[f] = d,
                b._roots.push(d))
            } else
                "id" === e && (a.oldValue != c && delete b._idMap[a.oldValue],
                a.newValue != c && (b._idMap[a.newValue] = d));
      ...
      , Rc = _("qc.widget.SelectionModel", b, function(a) {
        ...
        _setDataModel: function(a) {
            var b = this
              , c = b._dataModel;
            c !== a && (c && (b.clearSelection(),
            c.off("dataModelChange", b.handleDataModelChange, b)),
            b._dataModel = a,
            a.on("dataModelChange", b.handleDataModelChange, b),
            b.epc("dataModel", c, a))
        },
        ...
        handleDataModelChange: function(a) {
            ...
            if ("remove" === a.kind) {
                var c = a.data;
                b.isSelected(c) && (Va(b._list, c),
                delete b._map[c.uuid],
                b.esc("remove", [c]))
            } else
        ...
        filterArray: function(a, b) {
            ...
            for (var d, e = 0, f = Fa(a); e < f.length; e++)
                d = f[e],
                (c._selectableFunc && !c._selectableFunc(d) || b && c.isSelected(d) || !b && !c.isSelected(d) || !c._dataModel.contains(d)) && (f.splice(e, 1),
                e--);
            return f
        },
        appendSelection: function(a) {
            ...
            if ("none" === b._selectionMode)
                return b;
            var c, d, e = b._list, f = b.filterArray(a, !0);
            return f.length ? ("single" === b._selectionMode && (c = Fa(e),
            d = b._map,
            e.length = 0,
            b._map = {},
            f = [f[f.length - 1]]),
        ...
        selectAll: function() {
            ...
            if ("none" === a._selectionMode)
                return a;
            var b, d, e = Fa(a._dataModel.datas);
            if (a._selectableFunc)
                for (b = 0; b < e.length; b++)
                    a._selectableFunc(e[b]) || (e.splice(b, 1),
                    b--);
            var f = Fa(a._list)
              , g = a._map;
            for (a._list.length = 0,
            a._map = {},
            "single" === a._selectionMode && e.length > 1 && (e = [e[e.length - 1]]),
            b = 0; b < e.length; b++)
                d = e[b],
                a._list.push(d),
                a._map[d.uuid] = d;
      ...
      , cd = _("qc.widget.renderer.EnumRenderer", $c, function(a) {
        ...
        draw: function(a, b, d, e, f, g) {
            var h = this.getLabel(b)
              , i = this.getIcon(b)
              , j = this.indent;
            i != c && (da(a, i, null, d, e, this.indent, g, this._data, this._table),
            d += j,
            f -= j),
    ...
    G(Qc, {
        ...
        moveTo: function(a, b) {
            var c = a.siblings
              , d = c.indexOf(a);
            return d === b || 0 > d ? this : (b >= 0 && b <= c.length && (Va(c, a),
            b > c.length && b--,
            Ua(c, a, b),
    ...
    G(A, {
        ...
        arc: function(a, b, d, e, f, g) {
            ...
            k ? (h = -h,
            i = -i,
            ub(a, l, n, h, i - h, e / 2, f / 2, !0)) : a.arc(l, n, m(e, f) / 2, h, i),
            j && a.closePath()
        },
    ...
    _("qc.widget.List", b, function(a, b) {
        ...
        drawRow: function(a, b, d, e, f, g) {
            ...
            h._checkMode && (da(a, h.getCheckIcon(b), c, i, e, j, g, b, h),
            i += j),
        ...
        checkMode: {
            set: function(a) {
                var b = this
                  ...
                  , d = b.checkColumn
                  , e = b._checkMode;
                a !== e && (a ? c.contains(d) || c.add(d, 0) : c.contains(d) && c.remove(d),
                b._checkMode = a,
                b.epc("checkMode", e, a))
            },
            get: function() {
    ...
    _("qc.widget.Tree", b, function(a, b) {
        ...
        isOnToggleIcon: function(a) 
		{
            ...
            if (!b)
			{
				console.log("没点在Toggle上");
				return !1;
			}
                
            if (this.getToggleIcon(b)) 
			{
                var c = 12//this._indent
                  , d = this.getLevel(b)
                  , e = this.lp(a).x
                  , f = c * d;
				  
				  
				 var res = e >= f-5 && f + c +5 >= e ? !0 : !1;
				 //console.log("isOnToggleIcon:"+res+" e="+e +" f:"+f);
                return res;
            }
        }
    }, {
    ...
    _("qc.widget.PropertyTable", b, function(a, b) {
        ...
        validateModel: function() {
            ...
            c.forEach(function(c) {
                ...
                d.isExpanded && f.forEach(function(e) {
                    a.getCategoryName(e) === c && (d.properties.push(e),
                    b.push({
                        property: e,
                        data: a._currentData
                    }))
        ...
        validateImpl: function() {
            ...
            a._columnLineVisible && (sb(p, n, 0, 1, o, a._columnLineColor),
            sb(p, d - 1, 0, 1, o));
            for (var q = a._beginRowIndex; q < a._endRowIndex; q++) {
                var r = l[q]
                  , f = g * q;
        ...
        dataModel: {
            ...
            set: function(a) {
                var b = this
                  , c = b._dataModel;
                c !== a && (c && (c.off("dataPropertyChange", b.handleDataPropertyChange, b),
                b._selectionModel || c.selectionModel.off("selectionChange", b.ivm, b)),
                b._dataModel = a,
                a.on("dataPropertyChange", b.handleDataPropertyChange, b),
                b._selectionModel ? b._selectionModel._setDataModel(a) : a.selectionModel.on("selectionChange", b.ivm, b),
                b.epc("dataModel", c, a))
            }
        },
        propertyModel: {
    ...
    _("qc.widget.TableHeader", b, function(a, b) {
        ...
        validateImpl: function() {
            ...
            if (e.forEach(function(b) {
                ...
                i.rect(e, 0, g, d),
                i.clip(),
                f && f.column === c || a.drawColumn(i, c, e, 0, g, d),
                a._columnLineVisible && sb(i, e + g - 1, 0, 1, d, a._columnLineColor),
                i.restore())
            }),
            f) {
                var j = f.column
        ...
        drawColumn: function(a, b, d, e, f, g) {
            var h = this
              , i = h.getAlign(b);
            if (h.isMultiCheckableColumn(b) ? da(a, h._checkIcon, c, d, e, f, g) : oc(a, d, e, f, g, b.icon, h.getLabel(b), h.getLabelFont(b), h.getLabelColor(b), i, h._indent),
            b.sortable && h._table.sortColumn === b) {
    ...
    var td = _("qc.widget.layout.BorderLayout", b, function(a, b) {
        ...
        getPreferredSize: function(a) {
            var b, d = this, e = d._container;
            if (e._preferredSize)
                return e._preferredSize;
            if (e._calcdPreferredSizeMap || (e._calcdPreferredSizeMap = {}),
            a == c ? b = e._calcdPreferredSizeMap.nw : ("nw" !== a && isNaN(a) && console.error("BorerLayout: width is NaN"),
            b = e._calcdPreferredSizeMap[a]),
            !b) {
                var f = function(a, b) {
                    var e, f = d["_" + a + "View"];
                    return f ? ("center" === a && (b -= m.width,
                    b -= n.width),
                    e = f.getPreferredSize(isNaN(b) ? c : b)) : e = {
                        width: 0,
                        height: 0
                    },
                    {
        ...
        resetItems: function(a) {
            ...
            a && a.forEach(function(a) {
                var c = a.region;
                "left" === c ? (b.leftView = a.element,
                b.leftWidth = a.width) : "right" === c ? (b.rightView = a.element,
                b.rightWidth = a.width) : "top" === c ? (b.topView = a.element,
                b.topHeight = a.height) : "bottom" === c ? (b.bottomView = a.element,
                b.bottomHeight = a.height) : "center" === c && (b.centerView = a.element)
            })
        },
        removeChild: function(a) {
            var b = this;
        ...
        doLayout: function() {
            ...
            a._bh = A,
            a._th = z;
            var M, N = function(d, e, f, g, h, i, j, k, l) {
                var m = a["_" + d + "View"]
                  , n = a["_" + d + "Splitter"]
                ...
                if (t && (n.style.background = t,
                n.style.backgroundSize = "100% 100%"),
                wa(m, e, b._forceLayout),
                wa(n, g),
                wa(p, h),
                0 !== f && o)
                    ...
                    r && s) {
                        ...
                        x && (u.comps[0].background = "rgba(0, 0, 0, 0)",
                        ea(v, x, l.x, l.y, l.width, l.height, y[0], y[1], y[2], y[3])),
      ...
      , ud = (_("qc.widget.layout.SplitLayout", b, function(a, b) {
        ...
        doLayout: function() {
            ...
            if (b.width != c && b.height != c && b.isInDOM()) {
                var p = a._coverDiv;
                g >= k || 0 === g ? a._coverDiv && (Ba(a._coverDiv),
                delete a._coverDiv) : p || (p = a._coverDiv = ra(),
                Rb && (p.style.background = "rgba(255,255,255,0)"),
                za(n, p));
                var q = a.leftView
                  , r = a.rightView;
                if ("h" === a.orientation) {
    ...
    _("qc.widget.layout.AccordionLayout", b, function(a, b) {
        ...
        expand: function(a) {
            var b = this;
            b._titleMap[a] && b._currentTitle !== a && (b._currentTitle = a,
            b.onExpanded(a),
            b._container.iv())
        },
        onExpanded: function() {},
        collapse: function() {
            var a = this;
            a._currentTitle && (a.onCollapsed(a._currentTitle),
            delete a._currentTitle,
            a._container.iv())
        },
        ...
        doLayout: function() {
            ...
            a._titleList.forEach(function(j) {
                var k, n, o = a._titleMap[j], p = o.element, q = a._currentTitle === j;
                "horizontal" === g || "h" === g ? (wa(o.div, c, 0, h, f),
                k = a.initCanvas(o.canvas, h, f),
                Xb(k, 0, f),
                Yb(k, -s),
                a.drawTitle(k, j, f, h, o),
                k.restore(),
                q ? (n = l(0, e - i),
                p && (a._currentElement = p,
                a._currentView = va(p),
                m(),
                wa(p, c + h, 0, n, f, b._forceLayout)),
                c += h + n) : c += h) : (wa(o.div, 0, d, e, h),
                k = a.initCanvas(o.canvas, e, h),
                a.drawTitle(k, j, e, h, o),
                k.restore(),
                q ? (n = l(0, f - i),
                p && (a._currentElement = p,
                a._currentView = va(p),
                m(),
                wa(p, 0, d + h, e, n, b._forceLayout)),
                d += h + n) : d += h)
            }),
    ...
    _("qc.widget.layout.FitLayout", b, function(a, b) {
        ...
        getPreferredSize: function(a) {
            ...
            if (e._preferredSize)
                return e._preferredSize;
            if (e._calcdPreferredSizeMap || (e._calcdPreferredSizeMap = {}),
            a == c ? b = e._calcdPreferredSizeMap.nw : ("nw" !== a && isNaN(a) && console.error("FitLayout: width is NaN", a),
            b = e._calcdPreferredSizeMap[a]),
            !b) {
                var f = d._contentObj
                  , g = d.content
                ...
                if (f && g) {
                    ...
                    Sa(h) ? (b.width += h[1] + h[3],
                    b.height += h[0] + h[2]) : (b.width += 2 * h,
                    b.height += 2 * h),
                    e._calcdPreferredSizeMap[a == c ? "nw" : a] = b
                }
            }
        ...
        onPropertyChange: function(a) {
            var b = this
              , d = b._container
              , e = a.property;
            if (d.checkChildPreferredSizeChange(e, b._preferredSizeProperties),
            "content" === e) {
                var f = a.oldValue
                  , g = a.newValue;
        ...
        doLayout: function() {
            var a, b, c, d, e = this, f = e._container, g = f.clientWidth, h = f.clientHeight, i = g, j = h, k = e.htmlFill, l = f._contentDiv, m = e._contentObj, n = e.content, o = e.padding;
            if (n) {
                if (Sa(o) ? (c = o[0],
                b = o[1],
                d = o[2],
                ...
                else if (m.style.font = e._htmlFont,
                m.style.color = e._htmlColor,
                m.style.paddingTop = c + "px",
                m.style.paddingRight = b + "px",
                m.style.paddingBottom = d + "px",
                m.style.paddingLeft = a + "px",
                k) {
                    m.style.width = "100%",
                    m.style.height = "100%";
                    var p = m.children;
                    1 === p.length && (p[0]._oldWidth = p[0].style.width,
                    p[0]._oldHeight = p[0].style.height,
                    p[0].style.width = "100%",
                    ...
                    m.style.height = "";
                    var p = m.children;
                    1 === p.length && (p[0].style.width = p[0]._oldWidth,
                    p[0].style.height = p[0]._oldHeight)
                }
                f._viewRect = {
                    x: -f.translateX,
                    y: -f.translateY,
      ...
      , vd = (_("qc.widget.layout.TableLayout", b, function(a, b) {
        ...
        onPropertyChange: function(a) {
            var b = this
              ...
              , e = b._container
              , f = b.rows;
            if (e.checkChildPreferredSizeChange(d, b._preferredSizeProperties),
            "rows" === d || "rowVisible" === d) {
                var g = a.oldValue;
                if (g)
        ...
        getPreferredSize: function() {
            var a, b, c, d, e = this, f = e._container, g = e.rows, h = e._rowHeight, i = e.padding, j = [], k = 0, l = 0, m = f._preferredSize || f._calcdPreferredSize;
            if (Sa(i) ? (a = i[0],
            b = i[1],
            c = i[2],
            d = i[3]) : a = b = c = d = i,
        ...
        doLayout: function() {
            var a, b, c, d, e, f, g = this, i = this._container, j = g._rowHeight, k = i.clientWidth, m = i.clientHeight, n = i._contentDiv, o = g.rows || [], p = g.padding, q = 0, r = 0, s = m, t = k, u = [], v = [], w = [];
            Sa(p) ? (a = p[0],
            b = p[1],
            c = p[2],
            d = p[3]) : a = b = c = d = p,
            ...
            for (var B = 0; B < o.length; B++) {
                ...
                if (y.visible !== !1) {
                    var z = y.height;
                    null == z ? z = j : Pa(z) ? (e = z.split("+"),
                    z = parseFloat(e[0]),
                    z += parseFloat(e[1]) * s / q) : z > 1 || (z = z * s / q),
                    w.push(z)
                }
            }
            for (var B = 0; B < u.length; B++) {
                ...
                Pa(A) ? (e = A.split("+"),
                A = parseFloat(e[0]),
                A += parseFloat(e[1]) * t / r) : A > 1 || (A = A * t / r),
                v.push(A)
            }
                            ...
                            "none" === T) {
                                ...
                                0 >= Z || 0 >= $)
                                    ...
                                    if (U) {
                                        ...
                                        X = Math.min(aa.width, Z),
                                        Y = Math.min(aa.height, $);
    ...
    _("qc.widget.layout.HBoxLayout", b, function(a, b) {
        ...
        onPropertyChange: function(a) {
            var b = this
              ...
              , d = b._container
              , e = a.newValue;
            if (d.checkChildPreferredSizeChange(c, b._preferredSizeProperties),
            "components" === c) {
                var f = d._contentDiv;
                e && (f.appendChild(b._rightGapDiv),
                f.appendChild(b._bottomGapDiv)),
                d.iv(!0)
            }
            d.iv()
        },
        getPreferredSize: function() {
            ...
            if (!c) {
                var d, e, f, g, h = a.padding, i = a.gap, j = a.components, k = 0, m = 0;
                if (Sa(h) ? (f = h[0],
                e = h[1],
                g = h[2],
                d = h[3]) : d = e = f = g = h,
        ...
        doLayout: function() {
            var a, b, c, d, e, f = this, g = f._container, h = f.align, i = 0, j = g.clientWidth, k = g.clientHeight, m = f.padding, n = f.gap, o = g._contentDiv, p = f.components || pa, q = 0;
            if (Sa(m) ? (d = m[0],
            c = m[1],
            e = m[2],
            b = m[3]) : b = c = d = e = m,
            ...
            "left" === h ? (g._scrollWidth = q,
            g._scrollHeight = k) : (g._scrollWidth = j,
            g._scrollHeight = k),
      ...
      , wd = (_("qc.widget.layout.VBoxLayout", b, function(a, b) {
        ...
        doLayout: function() {
            var a, b, c, d, e = this, f = e._container, g = 0, h = f.clientWidth, i = f.clientHeight, j = e.padding, k = e.gap, m = f._contentDiv, n = e.components || pa;
            Sa(j) ? (c = j[0],
            b = j[1],
            d = j[2],
            a = j[3]) : a = b = c = d = j;
    ...
    _("qc.widget.Container", b, function(a) {
        ...
        initCanvas: function() {
            ...
            if (a.gradientColor || a.gradient || a.ninePatchImage || a.background) {
                ...
                a._canvas && (b.removeChild(a._canvas),
                delete a._canvas)
        },
        getPreferredSize: function(a) {
        ...
        drawBackground: function() {
            ...
            if (g) {
                ...
                b)
                    ...
                    l = !0) : d && (k.fillStyle = d,
                    l = !0),
                    l && (k.rect(j.x, j.y, j.width, j.height),
                    k.fill())
                }
            }
        },
      ...
      , xd = _("qc.widget.Panel", wd, function Re(a) {
        ...
        getPreferredSize: function(a) {
            var b, d = this, e = d._container, f = d.titleVisible, g = d.state, h = d.borderWidth, i = d.titleHeight;
            if (d._preferredSize ? b = Fa(d._preferredSize) : (d._calcdPreferredSizeMap || (d._calcdPreferredSizeMap = {}),
            b = a == c ? d._calcdPreferredSizeMap.nw : d._calcdPreferredSizeMap[a]),
            !b && e) {
                var j, k, l, m, n = d.contentPadding;
                Sa(n) ? (l = n[0],
                k = n[1],
                m = n[2],
                j = n[3]) : j = k = l = m = n;
        ...
        initContainer: function(a) {
            var b = this
              , d = a.property;
            if ("content" === d) {
                var e, f = b.content, g = b._contentDiv, h = b._container;
                if (h && (h._parent = c,
                g.removeChild(h.view)),
                f && f.addToDOM)
                    e = b._container = f;
                else {
                    var e = new wd;
        ...
        onPropertyChange: function(a) {
            var b = this
              , c = a.property;
            if (b.initContainer(a),
            xd["super"].onPropertyChange.call(b, a),
            ["htmlFont", "htmlColor", "htmlFill", "content"].indexOf(c) >= 0) {
                var d = b._container;
                d && d.layout instanceof ud && (d.layout.htmlFill = b.htmlFill,
                d.layout.htmlFont = b.htmlFont,
                d.layout.htmlColor = b.htmlColor)
            }
        },
        ...
        validateImpl: function() {
            var a, b, d, e, f = this, g = f.size, h = g.width, i = g.height, j = f.titleVisible, k = f.titleHeight, l = f.view, m = f._interactionDiv, n = f._canvas, o = f._contentDiv, p = f.borderWidth, q = f.borderColor, r = f._container, s = f.contentPadding;
            Sa(s) ? (d = s[0],
            b = s[1],
            e = s[2],
            a = s[3]) : a = b = d = e = s;
            ...
            t = h - a - b - 2 * p,
            j ? (u = i - d - e - k - 2 * p,
            wa(o, a + p, k + d + p, t, u)) : (u = i - d - e - 2 * p,
            wa(o, a + p, d + p, t, u)),
            ta(n, h, i);
            var v = Ub(n, 0, 0, 1, {
                x: 0,
      ...
      , yd = _("qc.widget.Dialog", xd, function(a) {
        ...
        onPropertyChange: function(a) {
            var b = this
              , c = a.property;
            if (yd["super"].onPropertyChange.call(b, a),
            ["htmlFont", "htmlColor", "htmlFill", "content", "dialogContentPadding"].indexOf(c) >= 0) {
                var d = b._container;
                if (d) {
                    var e = d.layout.centerView;
                    e && e.layout instanceof ud && (e.layout.htmlFill = b.htmlFill,
                    e.layout.htmlFont = b.htmlFont,
                    e.layout.htmlColor = b.htmlColor,
                    e.layout.padding = b.dialogContentPadding)
                }
            }
        },
        ...
        validateImpl: function() {
            ...
            if (Pa(f)) {
                var l = Da();
                "topRight" === f ? (j = l.width - d,
                k = 0) : "topLeft" === f ? (j = 0,
                k = 0) : "bottomLeft" === f ? (j = 0,
                k = l.height - e) : "bottomRight" === f ? (j = l.width - d,
                k = l.height - e) : "center" === f && (j = (l.width - d) / 2,
                k = (l.height - e) / 2)
            } else
                j = f.x || 0,
                k = f.y || 0;
    ...
    ;
    {
        var zd = _("qc.widget.ContextMenu", b, function(a, b) {
            ...
            disableShortcut: function() {
                var a = this;
                a._mousetrap && (a._mousetrap.dispose(),
                delete a._mousetrap)
            },
            addTo: function(a) {
                if (a) {
            ...
            close: function(a) {
                var b = this;
                b.visible !== !1 && (b.visible = !1,
                b._hoverMenuItem = c,
                b.emit("hide", {
                    item: a
                }),
                w.onContextMenuClose && w.onContextMenuClose(b),
                b.unregisterCloseEvent(b._bindingHandleDocMouseDown))
            },
            dispose: function() {
                var a = this
                  , b = a._relatedView
                  , d = a._view;
                d && (Ba(d),
                b && b.removeEventListener("contextmenu", a._bindingHandleViewParentContextMenu),
                a._mousetrap && a._mousetrap.dispose(),
                a._view = a._items = a._relatedView = a._mousetrap = a._bindingHandleDocMouseDown = a._bindingHandleViewParentContextMenu = c)
            },
            getPosition: function() {
                return this._position
            },
            setPosition: function(a, b) {
                ...
                c.x !== d._position.x || c.y !== d._position.y) {
                    var e = d._position;
                    d._position = c,
                    d.epc("position", e, c)
                }
            ...
            _calcSize: function(a) {
                for (var b, c = 0, d = 0, e = this.labelFont, f = 0; f < a.length; f++) {
                    var g = a[f]
                      ...
                      , j = Ka(e, h);
                    if (this._itemsLevelMap[g._id] && (j.width += 25),
                    g.icon && (j.width += 20),
                    "check" === g.type || "radio" === g.type)
                        j.width += 20;
                    else
            ...
            validate: function() {
                var a = this;
                a._invalidate && (delete a._invalidate,
                a.emit("viewChange", {
                    kind: "beginValidate"
                }),
                a.validateImpl(),
                    ...
                    g.length > 0) {
                        ...
                        g.forEach(function(a) {
                            ...
                            c && a.shortcut && c.bind(a.shortcut, function(c) {
                                ...
                                b._isItemDisabled(a) || (a.action && a.action.call(b, a, c),
                                b.emit("action", {
                                    item: a,
                                    event: c
                                }))
            ...
            drawRowBackground: function(a, b, c, d, e, f) {
                var g, h = this, i = !1, j = h._hoverMenuItem, k = h._itemsMap;
                if (j) {
                    for (var l = j; l && l !== b; )
                        l = k[l._pid];
                    l === b && "-" !== l.type && (i = !0,
                    g = h._hoverBackground)
                }
                return g && sb(a, c, d, e, f, g),
                i
            },
            drawChildren: function(a, b, d) {
                var e, f, g, h, i = this, j = i._itemsLevelMap, k = i._itemsDomMap, l = i._ninePatchImage, m = i._ninePatchBorder || [], n = i._rowHeight, o = i.labelFont, p = 20, q = i._borderWidth, r = i._borderColor, s = i._padding, t = i._leftGap, v = i._rightGap, w = i._hoverMenuItem, x = i._itemsMap, y = b ? b._id : 0, z = j[y];
                if (Sa(s) ? (e = s[0],
                f = s[1],
                g = s[2],
                h = s[3]) : e = f = g = h = s,
                z) {
                    ...
                    for (var L = e, J = 0; J < z.length; J++) {
                        ...
                        if ("-" === K.type) {
                            ...
                            var S = h + t + (I ? 22 : 4);
                            K.icon && (da(H, K.icon, c, S, L, p, n),
                            S += p);
                            var T = N ? i._hoverLabelColor : i._labelColor
                              , U = i._isItemDisabled(K);
                            if (U && (T = i.disabledLabelColor),
                            fa(H, K.label, o, T, S, L, B.width, n),
                            O && (S = j[K._id] ? B.width + h + t - 20 - C : B.width + h + t - 5 - C,
                            fa(H, O, o, T, S, L, C, n, "right")),
                            j[K._id]) {
                                var V = {
                                    width: 16,
                                    height: 16,
        ...
        _("qc.widget.Menu", b, function(a) {
                    ...
                    d) {
                        ...
                        b.forEach(function(a) {
                            a.shortcut && b._mousetrap.bind(a.shortcut, function(c) {
                                ...
                                b._dropDownMenu._isItemDisabled(a) || (a.action && a.action.call(b, a, c),
                                b.emit("action", {
                                    item: a,
                                    event: c
                                }))
            ...
            drawBackground: function(a, b, c, d, e, f) {
                var g, h, i, j, k = this, l = k.backgroundGradient || "linear.north";
                if ("background" === f ? k.ninePatchImage ? (g = k.ninePatchImage,
                h = k.ninePatchBorder || []) : (i = k.background,
                j = k.gradientColor) : "hover" === f ? k.hoverNinePatchImage ? (g = k.hoverNinePatchImage,
                h = k.hoverNinePatchBorder || []) : (i = k.hoverBackground,
                j = k.hoverGradientColor) : "active" === f && (k.activeNinePatchImage ? (g = k.activeNinePatchImage,
                h = k.activeNinePatchBorder || []) : (i = k.activeBackground,
                j = k.activeGradientColor)),
                g)
                    ea(a, g, b, c, d, e, h[0], h[1], h[2], h[3]);
                else if (i) {
                    a.beginPath();
    ...
    e.widget.Menu.prototype.dispose = function() {
        var a = this
          , b = a._view;
        b && (Ba(b),
        a._mousetrap.dispose(),
        a._dropDownMenu.dispose(),
        a._view = a._items = a._mousetrap = c)
    }
    ;
    {
        var Ad = _("qc.widget.ButtonBase", b, function(a) {
            ...
            getStateNinePatch: function(a) {
                ...
                if ("hover" === a) {
                    ...
                    d && (c.push(d),
                    c.push(b.hoverNinePatchBorder || []))
                } else if ("active" === a) {
                    var e = b.activeNinePatchImage;
                    e && (c.push(e),
                    c.push(b.activeNinePatchBorder || []))
                } else {
                    var f = b.ninePatchImage;
                    f && (c.push(f),
                    c.push(b.ninePatchBorder || []))
                }
                return c
            },
            ...
            validateImpl: function() {
                var a, b, c, d, e, f, g = this, h = g._canvas, i = g.clientWidth, j = g.clientHeight, k = g.getStateIcon(), l = g.padding, n = g.getTextColor(), o = g.textFont, p = g.iconWidth || ac(k) || 0, q = g.iconHeight || bc(k) || 0, r = g.iconAlign, s = g.align, t = g._textSize || {
                    width: 0,
                    height: 0
                };
                Sa(l) ? (a = l[0],
                ...
                var y = 0
                  , z = 0
                  , A = g.text;
                if (i = g.getIconTextWidth(),
                j = g.getIconTextHeight(),
                u.beginPath(),
                k && r) {
                    if ("left" === r) {
                        var B = g.iconStretch
            ...
            getPreferredSize: function() {
                var a = this
                  , b = a._preferredSize || a._calcdPreferredSize;
                if (!b) {
                    var c, d, e, f, g = a._textSize || a.textSize, i = a.icon, j = a.iconWidth || ac(i), k = a.iconHeight || bc(i), m = a.iconAlign, n = a.padding;
                    Sa(n) ? (c = n[0],
                    d = n[1],
                    e = n[2],
                    f = n[3]) : c = d = e = f = n,
                    ...
                    i && j && k && m && ("left" === m || "right" === m ? (g.width += j,
                    g.height = l(k, g.height)) : ("top" === m || "bottom" === m) && (g.width = l(j, g.width),
                    g.height += k)),
          ...
          , Bd = _("qc.widget.DropDownList", Ad, function(a) {
            ...
            onPropertyChange: function(a) {
                var b = this
                  , c = a.property;
                "value" === c && (b.onValueChange(a.newValue),
                b.iv())
            },
            ...
            items: {
                ...
                set: function(a) {
                    ...
                    b._items.forEach(function(a, b) {
                        var c = a
                          , f = a;
                        null != a && "object" == typeof a && (f = a.value,
                        c = a.label),
                        d[f] = b,
                        e[f] = c
                    }),
          ...
          , Cd = _("qc.widget.Button", Ad, function Se(a) {
            ...
            onPropertyChange: function(a) {
                var b = this
                  , c = a.property;
                ("menuItems" === c || "split" === c) && b.split === !0 && (b._contextMenu || (b._contextMenu = new zd,
                b._contextMenu.on("hide", function(a) {
                    a && a.item && (b._interactor.clear(),
                    b.state = "normal")
                })),
            ...
            validateImpl: function() {
                ...
                if (e) {
                    ...
                    if ("splitActive" === a._state) {
                        ...
                        g.visible && (g.hide(),
                        document.removeEventListener("mousedown", a._bindinghandle_documentmousedown)),
                        w.popup === a && (w.popup = c),
                        a._interactor._touchstart = null
                }
            },
            clear: function() {
                var a = this;
                a.isInDOM() || (a._contextMenu && a._contextMenu.dispose(),
                document.removeEventListener("mousedown", a._bindinghandle_documentmousedown))
            },
            getPreferredSize: function() {
                var a = this
                  , b = a._preferredSize || a._calcdPreferredSize;
                return b || (b = Cd["super"].getPreferredSize.call(a),
                a.split && (b.width += 30),
                b = a._calcdPreferredSize),
                b
            }
          ...
          , Ed = _("qc.widget.ToggleButton", Ad, function Ue(a) {
            ...
            getStateNinePatch: function(a) {
                var b, c = this, d = c.selected;
                if (d) {
                    b = [];
                    var e = c.activeNinePatchImage;
                    e && (b.push(e),
                    b.push(c.activeNinePatchBorder || []))
                } else
        ...
        _("qc.widget.Radios", b, function() {
            ...
            add: function(a) {
                var b = this
                  , c = b._buttons;
                a && c.indexOf(a) < 0 && (Ua(c, a),
                a.on("propertyChange", b.handleButtonSelectedChange, b))
            },
            remove: function(a) {
                var b = this
                  , c = b._buttons;
                a && c.indexOf(a) >= 0 && (Va(c, a),
                a.off("propertyChange", b.handleButtonSelectedChange, b))
            },
            clear: function() {
                var a = this
                  , b = a._buttons;
          ...
          , Gd = _("qc.widget.TextField", b, function(a) {
            ...
            validateImpl: function() {
                ...
                ta(o, f, g);
                var q = Ub(o, 0, 0, 1);
                if (j ? ea(q, j, 0, 0, f, g, l[0], l[1], l[2], l[3]) : h && (q.beginPath(),
                q.fillStyle = a.focused && i ? i : h,
                q.rect(0, 0, f, g),
                q.fill()),
                b.style.border = m ? "1px solid " + m : "",
                e != c && e !== d.value && (d.value = a.value),
                k) {
                    q.beginPath();
    ...
    _("qc.widget.Tabs", b, function(a) {
        ...
        hideTabView: function(a, b) {
            b.parentNode === this._contentDiv && ("IFRAME" === b.tagName ? (b.style.display = NONE,
            b._tab_ = a) : Ba(b),
            ma())
        },
        showTabView: function(a, b) {
            "IFRAME" === b.tagName && (b.style.display = "block",
            b._tab_ = a),
            b.parentNode !== this._contentDiv && (za(this._contentDiv, b),
            ma())
        },
        updateTabView: function() {
            var a, b = this, c = b._currentTab, d = b._currentView, e = b._tabModel.selectionModel.lastData;
            e && (a = va(e.element)),
            a !== d && (d && (c.element.endEditing && c.element.endEditing(),
            b.hideTabView(c, d)),
            a && b.showTabView(e, a)),
            b._currentTab = e,
            b._currentView = a,
        ...
        getStateNinePatch: function(a) {
            ...
            if ("active" === a) {
                ...
                d && (c.push(d),
                c.push(b.tabActiveNinePatchBorder || []))
            } else {
                var e = b.tabNinePatchImage;
                e && (c.push(e),
                c.push(b.tabNinePatchBorder || []))
            }
            return c
        },
        getStateBackground: function(a) {
        ...
        drawTab: function(a, b, c, d, e, f) {
            var g, h = this, i = h._tabPosition, j = c + 4, k = h.getTabIcon(b), l = b.disabled, m = h.getLabelColor(b), n = h.getLabelFont(b), o = h.getLabel(b), p = "left-vertical" === i, r = "right-vertical" === i;
            (p || r) && (j = d + 4);
            var t = "linear.north";
            ...
            k) {
                ...
                if (p || r) {
                    ...
                    h.isPanel && (j = c + 8),
                    da(a, k, null, j, d, x, f, b, h),
                    j += x + 4,
                    h.isPanel && (j += 6)
            }
            return p || r ? (Xb(a, e / 2, j + e / 2),
            Yb(a, s),
            Xb(a, -e / 2, -j - e / 2),
            fa(a, o, n, m, c, j, f, e),
            Xb(a, e / 2, j + e / 2),
            Yb(a, -s),
            Xb(a, -e / 2, -j - e / 2)) : fa(a, o, n, m, j, d, e, f),
            p && (Xb(a, v, d + f / 2),
            Yb(a, -q),
            Xb(a, -v, -d - f / 2)),
            b.closable && (a.strokeStyle = m,
            a.lineWidth = 1,
            a.beginPath(),
            r ? (a.moveTo(c + e - 10, d + f - 4),
        ...
        drawLeftRightVerticalTabs: function(a, b) {
            ...
            var o = Ub(d, 0, c.translateY, 1)
              , p = 0;
            if (o.clearRect(0, 0, g, b),
            o.rect(0, 0, g, b),
            o.fillStyle = c._titleBackground,
            o.fill(),
            i.length = 0,
            f._roots.forEach(function(b) {
                var d, e = c.getTabWidth(b);
                m && m.tab === b || (d = c.drawTab(o, b, 0, p, g, e, c._tabBackground),
                d && k && (d.x = a - 12)),
                i.push({
                    closeRect: d,
                    tab: b,
        ...
        drawLeftRightTabs: function(a, b, c) {
            ...
            var p = Ub(e, 0, d.translateY, 1)
              , q = 0;
            if (p.clearRect(0, 0, c, b),
            p.rect(0, 0, c, b),
            p.fillStyle = d._titleBackground,
            p.fill(),
            j.length = 0,
            g._roots.forEach(function(b) {
                var e;
                n && n.tab === b || (e = d.drawTab(p, b, 0, q, c, i),
                e && m && (e.x = a - 12)),
                j.push({
                    closeRect: e,
                    tab: b,
            ...
            s && (p.beginPath(),
            p.rect(s.x, s.y, s.width, s.height),
            p.fill()),
            p.restore(),
        ...
        drawTopBottomTabs: function(a, b) {
            ...
            var o = Ub(d, c.translateX, 0, 1)
              , p = 0;
            if (o.clearRect(0, 0, a, g),
            o.rect(0, 0, a, g),
            o.fillStyle = c._titleBackground,
            o.fill(),
            i.length = 0,
            f._roots.forEach(function(a) {
                var d, e = c.getTabWidth(a);
                m && m.tab === a || (d = c.drawTab(o, a, p, 0, e, g),
                d && k && (d.y = b - g)),
                i.push({
                    closeRect: d,
                    tab: a,
        ...
        validateImpl: function() {
            var a, b = this, c = b._tabPosition, d = b._contentDiv, e = b._tabModel, f = b.clientWidth, g = b.clientHeight, h = "left" === c, i = "right" === c, j = "left-vertical" === c, k = "right-vertical" === c, m = 0;
            (h || i) && e._roots.forEach(function(a) {
                m = l(b.getTabWidth(a), m)
            }),
            a = b._layoutTitle(f, g, m),
            wa(d, a),
            b._currentTab && (h || i ? a.x = 0 : j || k ? a.x = 0 : a.y = 0,
            wa(b._currentTab.element, a, b._forceLayout)),
        ...
        onPropertyChange: function(a) {
            ...
            if ("items" === c || "selectionMode" === c) {
                var d = b._radios
                  ...
                  , f = b.selectionMode;
                if (d.clear(),
                d.off("propertyChange", b.handleChildPropertyChange, b),
                "items" === c) {
                    var g = a.oldValue;
                    if (g)
                        for (var h = 0; h < g.length; h++) {
        ...
        value: {
            ...
            set: function(a) {
                var b = this
                  ...
                  , f = b.children;
                b._value = a,
                f && ("single" === e ? (b._flag = !0,
                f.forEach(function(b) {
                    b.value === a && (b.selected = !0)
                }),
                b._flag = !1) : a != c && (Sa(a) || (a = [a]),
                b._flag = !0,
                f.forEach(function(b) {
    ...
    var Jd = (_("qc.widget.ComboBox", b, function(a) {
        ...
        var j = function(a) {
            if (Eb(a)) {
                var c = a.target;
                (g.contains(c) || c === b._input) && (K(a),
                b.toggle())
            }
        };
        if (b.addEventListener("touchstart", j, !1),
        b.addEventListener("mousedown", j, !1),
        b._bindHandleDocumentClick = b._handleDocumentClick.bind(b),
        !w.isSubClassOf(b.dropDown, "qc.widget.DropDownTemplate"))
        ...
        onPropertyChange: function(a) {
            ...
            b.checkChildPreferredSizeChange(c),
            "value" === c ? (b.onValueChange(a.newValue),
            b.iv()) : "background" === c ? b._view.style.background = a.newValue : ["data", "valueField", "labelField", "iconField"].indexOf(c) >= 0 && b._initSelf()
        },
        registerCloseEvent: function(a) {
        ...
        open: function(a) {
            var b, c = this, e = Da(), f = c._view.getBoundingClientRect();
            if (w.popup = c,
            b = c._initDropDownComponent(),
            c._editable) {
            ...
            if ("qc.widget.ColorChooserDropDown" === a.dropDown || w.isSubClassOf(a.dropDown, "qc.widget.ColorChooserDropDown")) {
                if (a._componentConfig["colorChooser.alphaEnabled"])
                    for (var o = 5, p = j(b / o), q = j(d / o), r = 0; p > r; r++)
                        for (var s = 0; q > s; s++)
                            n.fillStyle = (r + s) % 2 === 0 ? "#808080" : "#CCCCCC",
                            n.fillRect(l + s * o, m + r * o, o, o);
                ...
                n.rect(l, 0, f - l, b),
                n.clip(),
                fa(n, h, c, c, l, 0, f - l, b),
                n.restore(),
                da(n, a._dropDownIcon, c, d - e, 0, e, b);
            n.restore()
        },
        getToolTipAt: function() {
            return this.toolTip
    ...
    _("qc.widget.DropDownTemplate", b, function(a) {
      ...
      , Kd = _("qc.widget.ColorChooser", b, function(a) {
        ...
        var d = function(a, c) {
          ...
          , g = function(a) {
            "hex" === a ? (f.maskRe = /^[0-9a-fA-F]$/,
            f.maxLength = 7) : (f.maskRe = /^[\d]$/,
            f.maxLength = 3);
        ...
        getHsv: function(a) {
            ...
            var b, c, d = a.r / 255, e = a.g / 255, f = a.b / 255, g = l(l(d, e), f), i = m(m(d, e), f), j = g;
            if (i == g)
                b = 0,
                c = 0;
            else {
        ...
        drawColors: function(a, b, c, d, e) {
            var f = this
              ...
              , h = f.labelMargin
              , i = f.isExpand("Colors");
            if (f.drawLabel(a, b, c, d, g, "Colors"),
            i) {
                c += g + h,
                a.beginPath(),
                a.rect(b, c, e, e),
        ...
        drawSliders: function(a, b, c, d) {
            ...
            if (e.drawLabel(a, b, c, d, f, "Sliders"),
            !h)
                return void ["r", "g", "b", "a"].forEach(function(a) {
                    Ba(e[a + "Text"].view)
                });
            c += f + g;
            var i, j = e.sliderHeight, k = 0;
        ...
        drawPreset: function(a, b, c, d, e) {
            ...
            if (255 === e.a)
                ...
                for (var h = d / 4, i = 0; 4 > i; i++)
                    for (var j = i; 4 > j; j++)
                        a.fillStyle = (i + j) % 2 === 0 ? "#808080" : "#CCCCCC",
                        a.fillRect(b + j * h, c + i * h, h, h);
        ...
        drawPresets: function(a, b, c, d) {
            var e = this
              ...
              , j = e.addPresetButton;
            if (e.drawLabel(a, b, c, d, f, "Presets"),
            !h)
        ...
        getPreferredSize: function() {
            var a = this
              ...
              , e = a.labelMargin
              , f = a.padding;
            if (d += 5 * f + a.resultHeight + 3 * a.labelHeight,
            a.isExpand("Colors") && (d += a.colorsHeight,
            d += e),
            a.isExpand("Sliders") && (d += 4 * a.sliderHeight,
            a.alphaEnabled || (d -= a.sliderHeight),
            d += e),
            a.isExpand("Presets")) {
        ...
        onPropertyChange: function(a) {
            ...
            c.indexOf(a.property) >= 0 && (this._rects = {},
      ...
      , Ld = (_("qc.widget.Slider", b, function(a) {
        ...
        validateImpl: function() {
            ...
            "vertical" === a.orientation ? (p = (e - c) / (d - c) * (j - 2 * f - k),
            m = h(m),
            l = h(f + k / 2),
            o = j - 2 * f - k,
            a.drawBackground(r, m, l, g, o),
            a.drawForecolor(r, m, l, g, p),
            a.drawThumb(r, 0, f + p, i, k)) : (q = (e - c) / (d - c) * (i - 2 * f - k),
            m = h(f + k / 2),
            l = h(l),
            n = i - 2 * f - k,
            a.drawBackground(r, m, l, n, g),
            a.drawForecolor(r, m, l, q, g),
            a.drawThumb(r, f + q, 0, k, j)),
            r.restore()
        },
    ...
    e.widget.Default.define("qc.widget.ColorChooserDropDown", Jd, function(a) {
      ...
      , Md = _("qc.widget.ListDropDown", Jd, function(a) {
        var b, c = this, d = c._dataModel = new e.widget.DataModel, f = c._view = new e.widget.List(d);
        for (var g in a)
            if (g.indexOf("list.") >= 0) {
                var h = a[g]
                  , i = g.replace("list.", "");
        ...
        createData: function(a, b) {
            var d, e, f, g = this, h = g.master, i = new Pc;
            if ("string" == typeof a)
                e = d = a;
      ...
      , Pd = _(c, Od, function(a) {
        ...
        handleScroll: function(a, b) {
            var c, d, e, f = this, g = f.view.getInput();
            b > 0 ? (c = g.scrollTop,
            0 >= c ? a.preventDefault() : a.stopPropagation()) : 0 > b && (c = g.scrollTop,
            d = g.scrollHeight,
            e = g.offsetHeight,
            c >= d - e ? a.preventDefault() : a.stopPropagation())
        }
    })
      , Qd = _(c, b, function(a) {
        ...
        handle_mousemove: function(a) {
            var b = this._colorChooser;
            b._state && "button" !== b._state[1] && (Bb(this, a),
            K(a))
        },
        ...
        handleWindowMouseMove: function(a) {
            ...
            if ("presets" !== c[1]) {
                var d = b._rects[c[0]][c[1]]
                  ...
                  , i = e.y - d.y - f.top
                  , j = b.getHsv();
                switch (g = g >= d.width ? d.width : 0 > g ? 0 : g,
                i = i >= d.height ? d.height : 0 > i ? 0 : i,
                c[1]) {
      ...
      , Rd = _(c, b, function(a) {
        ...
        clear: function(a) {
            ...
            d.draggingData && (d.draggingData = null,
            d.iv()),
        ...
        handle_touchstart: function(a) {
            ...
            b._tx = c.translateX,
            b._ty = c.translateY,
            Eb(a) ? (b._isV = c.isCloseToVScrollBar(a),
            b._isH = c.isCloseToHScrollBar(a),
            !d && c.clearSelectionOnBackgroundClicked && c.selectionModel.clearSelection(),
            d && c.handleDragAndDrop && !b._isV && !b._isH && (c.draggingData = d,
            c.iv(),
            c.handleDragAndDrop(a, "prepare")),
            Bb(b, a)) : (d && b.handleSelectMode(a, d),
            b.clear(a))
        },
        handle_mousemove: function(a) {
        ...
        handle_touchend: function(a) {
            ...
            if (!b._isV && !b._isH && b._clientPoint && !b._state) {
                var d = c.getDataAt(a);
                d && (c.checkMode ? b.handleCheckMode(a, d) : b.handleSelectMode(a, d),
                b.handleClickCallback(d, a))
            }
            b.clear(a)
        },
        ...
        handleWindowTouchMove: function(a) {
            ...
            if (d)
                ...
                if (2 > j)
                    return;
                b._isV ? b._state = "vScroll" : b._isH ? b._state = "hScroll" : c.draggingData && !this._dragCancel ? (b._state = "dnd",
                c.handleDragAndDrop(a, "begin")) : b._state = "pan",
                b._state && "dnd" !== b._state && c.draggingData && (c.draggingData = null,
                c.iv())
            }
        },
        handle_mousewheel: function(a) {
        ...
        handle_keydown: function(a) {
            var b, c = this.view, d = c.selectionModel, e = c._rows;
            if (K(a),
            Hb(a))
                c.selectAll();
            else if (Ib(a))
                ...
                "dnd" !== this._state || this._dragCancel || (c.handleDragAndDrop(a, "cancel"),
                this._dragCancel = !0);
            else if (Nb(a))
                c.checkMode && (b = c.focusData,
                b && c.checkData(b));
            else if (Kb(a) || Mb(a)) {
                var f = c.checkMode;
                if (b = f ? c.focusData : d.lastData,
                b && c.getRowIndex(b) >= 0) {
                    var g = c.getRowIndex(b);
                    Kb(a) ? 0 !== g && (b = e[g - 1],
                    f ? c.focusData = b : d.selection = b) : g !== e.length - 1 && (b = e[g + 1],
                    f ? c.focusData = b : d.selection = b)
                } else
                    e.length && (b = e[0],
                    f ? c.focusData = b : d.selection = b)
            }
      ...
      , Td = _("qc.widget.TreeInteractor", Rd, function(a) {
        ...
        toggle: function(a, b) {
            var c = this.view;
            return c.isOnToggleIcon(a) ? (c.toggle(b),
            !0) : c.toggleOnDoubleClick && Db(a) ? (c.toggle(b),
            !0) : !1
        },
        handleClickCallback: function(a, b) {
        ...
        handle_keydown: function(a) {
            if (Jb(a) || Lb(a)) {
                ...
                f ? Jb(a) ? b.collapse(f) : b.expand(f) : c.length > 0 && (f = c[0],
                d ? b.focusData = f : e.selection = f)
            } else
      ...
      , Vd = _(c, b, function(a) {
        ...
        handle_touchstart: function(a) {
            ...
            Eb(a) ? (b._cp = xa(a),
            b._ty = c.translateY,
            b._p = c.columnPosition,
            b.handle_touchmove(a)) : c.selectRowIndex = c.getRowIndexAt(a)
        },
        ...
        handle_touchmove: function(a) {
            if (!Ab() && Eb(a)) {
                ...
                b._cp ? b._state || (d ? (b._state = "resize",
                Bb(b, a)) : n(xa(a).y - b._cp.y) >= 2 && (b._state = c.isCloseToVScrollBar(a) ? "scroll" : "pan",
                Bb(b, a))) : (b.cursor = d ? "ew-resize" : "",
                c.isCloseToVScrollBar(a) && c.showScrollBar())
            }
        },
        handle_mousewheel: function(a) {
      ...
      , Wd = _(c, b, function(a) {
            ...
            if (!Ab()) {
                ...
                for (var c = b.view, d = c._columnInfos, e = c.lp(a).x, f = d.length - 1; f >= 0; f--) {
                    ...
                    if (c.resizable && n(i - e) <= (Qb(a) ? 3 : 8))
                        return b._columnInfo = g,
                        void (b.cursor = "ew-resize");
                    (h.sortable || c.movable || h === c._table.checkColumn) && e >= g.beginX && i >= e && h.width > 0 && (b._columnInfo = g,
                    b.cursor = "pointer")
                }
            }
        },
        ...
        handle_touchstart: function(a) {
            ...
            b._columnInfo && (b._x = xa(a).x,
            b._lx = c.lp(a).x,
            b._w = b._columnInfo.column.width,
            Bb(b, a))
        },
        handleWindowMouseMove: function(a) {
            this.handleWindowTouchMove(a)
        ...
        handleWindowTouchMove: function(a) {
            var b = this
              ...
              , e = b._columnInfo
              , f = xa(a).x - b._x;
            if (b._resizing || b._moving || ("ew-resize" === d ? b._resizing = !0 : c.movable && "pointer" === d && n(f) > 2 && (b._moving = !0)),
            b._resizing)
            ...
            if (b._moving) {
                ...
                if (o && m >= n && m <= g.endX && !b.handleCheckColumn(i, n, a)) {
                    if (i.sortable) {
                        var q = e.sortMode
                          , r = i.sortOrder;
                        "tristate" === q ? e.sortColumn === i ? ("desc" === r && (e.sortColumn = c),
                        i.sortOrder = "asc" === r ? "desc" : "asc") : e.sortColumn = i : "bistate" === q && (e.sortColumn === i ? i.sortOrder = "asc" === r ? "desc" : "asc" : e.sortColumn = i)
                    }
                    e.onColumnClick(i, a)
                }
            }
      ...
      , Xd = _("qc.widget.PanelInteractor", b, function(a) {
        ...
        handle_touchstart: function(a) {
            var b = this
              ...
              , e = b._toolIndex;
            e != c && (K(a),
            b._startToolPoint = xa(a),
            b._mouseState = "active",
            d.iv(),
            Bb(b, a))
        },
        handleWindowMouseUp: function(a) {
        ...
        handle_mouseleave: function() {
            var a = this
              , b = a._panel
              , c = a._mouseState;
            Ab() || "hover" !== c || (a._mouseState = "normal",
            b.iv())
        },
        handleWindowTouchEnd: function(a) {
            var b = this
            ...
            e != c ? (b._mouseState = "hover",
            d.cursor = "pointer",
            d.iv()) : (b._mouseState = "normal",
            d.cursor = "",
            d.iv())
        },
        handle_mouseup: function(a) {
        ...
        handle_touchmove: function(a) {
            ...
            if (!Ab() && "active" !== e) {
                ...
                f !== g && (g != c ? (d.cursor = "pointer",
                b._mouseState = "hover") : (d.cursor = "",
                b._mouseState = "normal"),
                d.iv())
            }
        },
        handleWindowMouseMove: function(a) {
      ...
      , Yd = _("qc.widget.DialogInteractor", "qc.widget.PanelInteractor", function Ze(a) {
        ...
        handle_touchstart: function(a) {
            var b = this
              , d = b._panel;
            if (Yd["super"].handle_touchstart.call(this, a),
            a = Sb(a),
            b._toolIndex != c)
            ...
            if (d.titleVisible && 24 >= g && f > 5 && f < d.width - 5)
                b._mousePosition = ya(a),
                Bb(b, a),
                b._moveMode = 1;
            else if (d.resizable) {
                var h, i = d._eastResizeDiv, j = d._westResizeDiv, k = d._southResizeDiv, l = d._southeastResizeDiv, m = d._southwestResizeDiv;
        ...
        handleWindowTouchEnd: function(a) {
            ...
            if (Yd["super"].handleWindowTouchEnd.call(this, a),
            c && d) {
                var g = d.style.left
                  , h = d.style.width
                  , i = d.style.height;
        ...
        handle_touchmove: function(a) {
            ...
            !Ab() && d.resizable && (d._eastResizeDiv.contains(e) ? (d.cursor = "e-resize",
            b._toolIndex = c) : "e-resize" === d.cursor && b._toolIndex == c && (d.cursor = ""),
            d._westResizeDiv.contains(e) ? (d.cursor = "w-resize",
            b._toolIndex = c) : "w-resize" === d.cursor && b._toolIndex == c && (d.cursor = ""),
            d._southResizeDiv.contains(e) ? (d.cursor = "s-resize",
            b._toolIndex = c) : "s-resize" === d.cursor && b._toolIndex == c && (d.cursor = ""),
            d._southwestResizeDiv.contains(e) ? (d.cursor = "sw-resize",
            b._toolIndex = c) : "sw-resize" === d.cursor && b._toolIndex == c && (d.cursor = ""),
            d._southeastResizeDiv.contains(e) ? (d.cursor = "se-resize",
            b._toolIndex = c) : "se-resize" === d.cursor && b._toolIndex == c && (d.cursor = ""))
        },
        handle_mouseup: function(a) {
            this.handle_touchend(a)
        },
        ...
        handleWindowTouchMove: function(a) {
            ...
            c.dragContainment)
              , i = b._resizeMode;
            if (Yd["super"].handleWindowTouchMove.call(this, a),
            b._moveMode) {
                K(a);
                var j = f.x - d.x
                  , k = f.y - d.y
                ...
                var j = f.x - d.x
                  , k = f.y - d.y
                  , t = 50;
                /east/.test(i) ? (t > o + j && (j = t - o),
                q.style.width = o + j + "px") : /west/.test(i) && (t > o - j && (j = o - t),
                q.style.width = o - j + "px",
                q.style.left = r + j + "px"),
                /south/.test(i) && (t > p + k && (k = t - p),
                q.style.height = p + k + "px")
            }
        }
    })
      , Zd = _(c, b, function(a) {
        ...
        handle_touchstart: function(a) {
            var b = this
              ...
              , f = xa(a);
            d || e ? (K(a),
            d ? b._state = "vScroll" : e && (b._state = "hScroll"),
            b._cp = f,
            b._tx = c.translateX,
            b._ty = c.translateY,
            Bb(b, a)) : (a.target instanceof HTMLCanvasElement || c instanceof wd && a.target === c._contentDiv) && K(a)
        },
        handleWindowMouseUp: function(a) {
            this.clear(a)
        },
        ...
        handleScroll: function(a, b, c) {
            var d = this.view
              , e = d._viewRect
              , f = d.scrollRect;
            c && d.vScrollable ? (d.translate(0, 20 * b),
            b > 0 ? e.y <= 0 ? a.preventDefault() : a.stopPropagation() : 0 > b && (f.height - e.height <= e.y ? a.preventDefault() : a.stopPropagation())) : d.hScrollable && (d.translate(10 * b, 0),
            b > 0 ? e.x <= 0 ? a.preventDefault() : a.stopPropagation() : 0 > b && (f.width - e.width <= e.x ? a.preventDefault() : a.stopPropagation()))
        }
    }, {
        interactor: !0
    }, {
            ...
            if (d) {
                ...
                if (f) {
                    ...
                    var e = c["_" + f + "Resizable"]
                      , g = c.isExpanded(f);
                    e && g && (b._splitterName = f,
                    b._splitter = c["_" + f + "Splitter"],
                    b._clientPoint = xa(a))
                }
            }
        },
        ...
        handleWindowTouchMove: function(a) {
            ...
            if ("left" === p || "right" === p) {
                ...
                if ("left" === p) {
                    ...
                    x > g - k - h && (x = g - k - h),
                    r ? x < e._lw + j + h && (x = e._lw + j + h) : h > x && (x = h),
                    f.left = x + "px"
            } else {
                var z = u(o.style.top)
                  , w = xa(a)
                ...
                if ("top" === p) {
                    ...
                    x > n - m - h && (x = n - m - h),
                    s ? x < e._th + l + h && (x = e._th + l + h) : h > x && (x = h),
                    f.top = x + "px"
            }
        },
        handleWindowMouseUp: function(a) {
      ...
      , ae = _(c, b, function(a) {
        ...
        handle_touchmove: function(a) {
            var b = this
              ...
              , f = c._coverDiv
              , g = d.style;
            !Ab() && c.draggable && d.contains(e) ? "h" === c.orientation ? (g.cursor = "ew-resize",
            f && (f.style.cursor = "ew-resize")) : (g.cursor = "ns-resize",
            f && (f.style.cursor = "ns-resize")) : (g.cursor = "",
            f && (f.style.cursor = ""))
        },
        handle_touchstart: function(a) {
            var b = this
        ...
        handleWindowTouchMove: function(a) {
            ...
            "h" === d.orientation ? (b._clientValue = xa(a).x,
            k += b._clientValue,
            k > i - g - e && (k = i - g - e),
            g > k && (k = g),
            h.left = k + f) : (b._clientValue = xa(a).y,
            k += b._clientValue,
            k > j - g - e && (k = j - g - e),
            g > k && (k = g),
            h.top = k + f)
        ...
        handleWindowTouchEnd: function(a) {
            ...
            j > 1 && (0 > g && (g = 0),
            g > i - h && (g = i - h),
            i !== h && (e.position = "absoluteLeft" === f ? g : "absoluteRight" === f ? i - h - g : g / (i - h))),
      ...
      , be = _(c, b, function(a) {
        ...
        handleViewParentContextMenu: function(a) {
            ...
            var b = a.target
              , c = b.tagName;
            ("DIV" === c || "CANVAS" === c || "BODY" === c) && (a.preventDefault(),
            this._contextmenu.show(a))
        },
      ...
      , ce = _(c, b, function(a) {
        ...
        handle_documentmousedown: function(a) {
            var b = this._menu
              , d = a.target;
            b.view.contains(d) || b._dropDownMenu.view.contains(d) || (b.setState("normal"),
            b.setCurrentItem(c))
        },
        handle_touchstart: function(a) {
            var b = this
              , c = b._menu
              , d = c.getMenuItemAt(a);
            d ? (c.setState("active" === c._state ? "hover" : "active"),
            c.setCurrentItem(d)) : c.hide()
        },
        handle_mousedown: function(a) {
            this.handle_touchstart(a)
        },
        ...
        handle_mouseleave: function() {
            var a = this._menu;
            "active" !== a._state && (a.setState("normal"),
            a.setCurrentItem(c))
        },
        handle_mousemove: function(a) {
            this.handle_touchmove(a)
        ...
        handle_touchmove: function(a) {
            var b = this
              , c = b._menu
              , d = c.getMenuItemAt(a);
            d && ("active" === c._state || c.setState("hover"),
            c.setCurrentItem(d))
        },
        handleWindowTouchMove: function() {},
        handleWindowMouseMove: function(a) {
      ...
      , de = _(c, b, function(a) {
        ...
        handle_documentmousedown: function(a) {
            var b = this._button;
            b.view.contains(a.target) || b._contextMenu.view.contains(a.target) || (this.clear(),
            b.state = "normal")
        },
        handle_mousedown: function(a) {
            this.handle_touchstart(a)
        ...
        handle_touchstart: function(a) {
            ...
            var b = this
              ...
              , f = c.menuItems;
            c.requestFocus(),
            "splitActive" !== c.state && (f && c.split && a.clientX - e.left > e.width - 30 ? (c.state = "splitActive",
            b._touchstart = !0) : c.state = "active"),
            Bb(b, a)
        },
        handle_mouseup: function(a) {
            this.handle_touchend(a)
        ...
        handleWindowTouchEnd: function(a) {
            ...
            b.clear(),
            c.view.contains(a.target) && (c.validate(),
            c.emit("click", a))
        }
    }, {
        interactor: !0
      ...
      , ge = _(c, b, function(a) {
        ...
        handleWindowTouchEnd: function(a) {
            var b = this
              , c = b._button;
            b._pressed && ("active" === c._state && (c._state = c.view.contains(a.target) ? "hover" : "normal",
            c.iv()),
            c.view.contains(a.target) && (c.selected = !c.selected,
            c.validate(),
            c.emit("click", a)),
            b.clear())
        }
      ...
      , ie = _(c, b, function(a) {
        ...
        getTabInfoAt: function(a) {
            var b, d, e = this._tabs, f = e._tabPosition, g = e._tabInfos;
        ...
        handle_touchstart: function(a) {
            var b = this
              ...
              , d = c._tabPosition;
            K(a),
            b.isClickable(a) && (["top", "bottom"].indexOf(d) >= 0 ? (b._x = xa(a).x,
            b._lp = c.lp(a),
            b._tx = c.translateX) : (b._y = xa(a).y,
            b._lp = c.lp(a),
            b._ty = c.translateY),
            Bb(b, a))
        },
        ...
        handleWindowTouchMove: function(a) {
            var b, c = this, d = c._tabs, e = d._tabPosition, f = c._tabInfo;
            if (["top", "bottom"].indexOf(e) >= 0) {
                if (b = xa(a).x - c._x,
                !c._translating && !c._moving && n(b) > 2 && (d.hScrollable && !Fb(a) ? c._translating = 1 : f && d.movable && (c._moving = 1)),
                c._translating)
            ...
            } else if (b = xa(a).y - c._y,
            !c._translating && !c._moving && n(b) > 2 && (d.vScrollable && !Fb(a) ? c._translating = 1 : f && d.movable && (c._moving = 1)),
            c._translating)
    ...
    var le = function(a, b, c, d) {
      ...
      , qe = function(a, b) {
        var c, d, e, f, g, h = a.length - 1, j = h * b, k = i(j);
        return a[0].x === a[h].x && a[0].y === a[h].y ? (0 > b && (k = i(j = h * (1 + b))),
        d = a[(k - 1 + h) % h],
        e = a[k % h],
        f = a[(k + 1) % h],
        g = a[(k + 2) % h],
                ...
                if (se(a)) {
                    ...
                    if (f)
                        for (d = 0; d < f.length; d++)
                            e = f[d],
                            e.isHostOn(a) ? (f.splice(d, 1),
                            d--,
                            Va(g, e)) : b && (a.isHostOn(e) || a.isLoopedHostOn(e)) && (b = !1);
                    b && (g.push(a),
                    (a._host || a._attaches) && (f || (f = []),
                    f.push(a)))
                }
            }),
            g.forEach(function(a) {
      ...
      , xe = function(a, b) {
        if (b) {
            ...
            if (g && (a.beginPath(),
            vb(a, c.x - h, c.y - h, c.width + 2 * h, c.height + 2 * h, b.cornerRadius),
            a.fillStyle = g,
            a.fill()),
            f) {
                var n = c.width
      ...
      , ye = function(a, b) {
        if (b) {
            ...
            if (b.expanded) {
                ...
                a.strokeStyle = j ? j : mb(h),
                a.beginPath(),
                a.arc(d + y, e + y, y, s, 1.6 * q, !0),
                a.moveTo(d + y, e + g),
                a.lineTo(d + f - y / 5, e + y),
                a.stroke(),
                a.strokeStyle = j ? j : lb(h),
                a.beginPath(),
                a.arc(d + y, e + y, y, 1.6 * q, s, !0),
                a.moveTo(d + y, e + g),
                a.lineTo(d + y / 5, e + y),
                a.stroke()),
                a.fillStyle = h,
      ...
      , ze = _("qc.widget.graph.Node", Pc, function $e(a) {
        ...
        setAnchor: function(a, b) {
            ...
            c.x !== d._anchor.x || c.y !== d._anchor.y) {
                var e = d._anchor;
                d._anchor = c,
                d.epc("anchor", e, c)
            }
        ...
        setSize: function(a, b) {
            var c = this;
            2 === arguments.length ? (c.width = a,
            c.height = b) : (c.width = a.width,
            c.height = a.height)
        },
        onPropertyChange: function(a) {
            var b = this;
    ...
    _("qc.widget.graph.Shape", ze, function af(a) {
        ...
        setPosition: function(a, b) {
            ...
            if (!d._updatingShapePosition) {
                if (d._updatingShapePosition = !0,
                !d._updatingShape && !w.deserializing) {
                    c = 2 === arguments.length ? {
                        x: a,
                        y: b
                    } : a;
        ...
        emitShapeChange: function() {
            ...
            if (!a._updatingShape && !w.deserializing) {
                var b = db(a._points);
                b && (a._updatingShape = !0,
                a.rect = b,
                delete a._updatingShape)
            }
            a.epc("shape", !1, !0)
        }
    }, {
        ...
        width: {
            ...
            set: function(a) {
                var b = this;
                if (.01 > a && (a = .01),
                !b._updatingShape && !w.deserializing && b.width) {
                    b._updatingShape = !0;
                    var c = b._position.x
                      , d = a / b.width
                      , e = [];
        ...
        height: {
            ...
            set: function(a) {
                var b = this;
                if (.01 > a && (a = .01),
                !b._updatingShape && !w.deserializing && b.height) {
                    b._updatingShape = !0;
                    var c = b._position.y
                      , d = a / b.height
                      , e = [];
    ...
    _("qc.widget.graph.Serializer", b, function(a) {
        ...
        serializeData: function(a) {
            ...
            if (b.isSerializable(a)) {
                var c, d, e, f = a["class"], g = b._game ? new f(b._game) : new f, h = {
                    c: a.className,
                    i: a.uuid,
                    p: {},
                    s: {},
                ...
                for (d in c)
                    e = a[d],
                    e !== g[d] && b.serializeValue(d, e, h.p);
                c = a.serializableStyles;
                for (d in c)
                    e = a.s(d),
                    e !== g.s(d) && b.serializeValue(d, e, h.s);
                c = a.serializableAttrs;
                for (d in c)
                    e = a.a(d),
                    e !== g.a(d) && b.serializeValue(d, e, h.a);
                Cb(h.p) && delete h.p,
                Cb(h.s) && delete h.s,
                Cb(h.a) && delete h.a
            }
    ...
    var Be = _(c, b, function(a, b) {
        ...
        updateLabel: function(a, b) {
            ...
            if (h != c) {
                var i = g(a + ".scale")
                  ...
                  , m = kb(l, h);
                j > 0 && j < m.width && (l.labelWidth = m.width,
                m.width = j),
                Oa(i) && (i = {
                    x: i,
                    y: i
                ...
                if (q && (p = Fa(m),
                i ? _a(p, q * n(i.x), q * n(i.y)) : _a(p, q)),
                d.addRect(p, l.rotation),
                i) {
        ...
        updateNote: function(a, b) {
            var d = this
              ...
              , h = e[b](f);
            if (h != c) {
                var i, k, l = g(a + ".scale"), m = d[a + "Info"] = {
                    note: h,
                ...
                }, n = d.getPosition(g(a + ".position"), g(a + ".offset.x"), g(a + ".offset.y")), o = n.x, p = n.y;
                Oa(l) && (l = {
                    x: l,
                    y: l
                }),
                ...
                if (m.expanded) {
                    ...
                    t.width += 6,
                    t.height += 2,
                    s > 0 && s < t.width && (m.labelWidth = t.width,
                    t.width = s),
                    i = t.width,
                    k = t.height + 8,
                    m.hitRect = {
      ...
      , Ce = _("qc.widget.graph.NodeUI", Be, function(a, b) {
        ...
        addExtraRect: function(a, b) {
            var c = this
              , d = c.s
              , e = a.rect;
            (a.borderColor = c.gv.getBorderColor(c.data)) && (a.borderType = d("border.type"),
            a.borderWidth = d("border.width"),
            a.borderPadding = d("border.padding"),
            b = l(b, a.borderPadding + a.borderWidth / 2)),
            (a.selectWidth = c.selectWidth) && (a.selectType = d("select.type"),
            a.selectColor = d("select.color"),
            a.selectPadding = d("select.padding"),
            b = l(b, a.selectPadding + a.selectWidth / 2)),
            b > 0 && (e = Fa(e),
            _a(e, b)),
            c.addRect(e)
        },
        drawExtra: function(a, b) {
            var c, d = this, e = b.rect;
            b.borderWidth && (c = b.borderPadding,
            ...
            pb(a, b.borderType, {
                ...
                width: e.width + 2 * c,
                height: e.height + 2 * c
            }, d.s("shape.info"), d.data, d.gv),
            a.stroke()),
            b.selectWidth && (c = b.selectPadding,
            a.strokeStyle = b.selectColor,
      ...
      , De = _(c, Ce, function(a, b) {
        ...
        drawBody: function(a) {
            ...
            var n = b.selectWidth
              ...
              , s = l(q, r);
            if (n && (a.strokeStyle = d("select.color"),
            a.lineWidth = s + 2 * (p + n),
            a.stroke()),
            p && (a.strokeStyle = o,
            a.lineWidth = s + 2 * p,
      ...
      , Ee = _("qc.widget.graph.GraphView", b, function(a) {
        ...
        invalidateAll: function(a) {
            ...
            b._visibleMap = {},
            b._dirtyMap = {},
            b._dirtyRects.length = 0,
            b.redraw()) : b.dataModel.forEach(function(a) {
                b.invalidateData(a)
            })
        },
        ...
        handleSelectionChange: function(a) {
            ...
            1 === c.length && ("set" === a.kind || "append" === a.kind)) {
                var e = c.lastData;
                if (b.autoMakeVisible && b.makeVisible(e),
                b.isVisible(e)) {
        ...
        dataModel: {
            ...
            set: function(a) {
                ...
                c !== a && (c && (c.off("dataModelChange", b.handleDataModelChange, b),
                c.off("dataPropertyChange", b.handleDataPropertyChange, b),
                c.off("indexChange", b.handleIndexChange, b),
                d || c.selectionModel.off("selectionChange", b.handleSelectionChange, b)),
                b._dataModel = a,
                a.on("dataModelChange", b.handleDataModelChange, b),
                a.on("dataPropertyChange", b.handleDataPropertyChange, b),
                a.on("indexChange", b.handleIndexChange, b),
                d ? d._setDataModel(a) : a.selectionModel.on("selectionChange", b.handleSelectionChange, b),
                b.invalidateAll(!0),
                b.epc("dataModel", c, a))
            }
    ...
    G(Ee, {
        forEach: function(a, b) {
            var c, d, e = 0, f = this._layers, g = this._dataModel._datas, h = g.length;
            if (f)
                for (; e < f.length; e++) {
                    d = f[e];
                    for (var i = 0; h > i; i++)
                        if (c = g[i],
                        c._layer === d && a.call(b, c) === !1)
                            return
                }
            else
                for (; h > e; e++)
        ...
        forEachReverse: function(a, b) {
            var c, d, e, f = this._layers, g = this._dataModel._datas, h = g.length;
            if (f)
                for (c = f.length - 1; c >= 0; c--) {
                    e = f[c];
                    for (var i = h - 1; i >= 0; i--)
                        if (d = g[i],
                        d._layer === e && a.call(b, d) === !1)
                            return
                }
            else
                for (c = h - 1; c >= 0; c--)
    ...
    G(Ee, {
        redraw: function(a) {
            var b = this;
            b._redrawAll || (a ? b._dirtyRects.push(a) : (b._redrawAll = !0,
            b._dirtyRects.length = 0),
            b.iv())
        },
        draw: function(a, b) {
        ...
        validateImpl: function() {
            var a, b, c, d, e, f = this, g = f.translateX, h = f.translateY, k = f._zoom, m = f._canvas, n = f.clientWidth, o = f.clientHeight, p = f._viewRect, q = f.calculateViewRect(), r = {}, s = f._dirtyRects, t = f._dirtyMap, u = f._redrawAll, v = f._makeVisibleData;
            (n !== m.clientWidth || o !== m.clientHeight) && (ta(m, n, o),
            u = 1),
            u || cb(q, p) || (u = 1),
            f._viewRect = q,
            ...
            for (b in t)
                c = f.getDataUI(t[b]),
                c && (!u && f._visibleMap[b] && (e = c.bounds,
                e && s.push(e)),
                c.invalidate()),
                f._invalidateContentRect = !0;
            if (f._visibleMap = r,
            !u)
                for (b in t)
                    r[b] && (c = f.getDataUI(t[b]),
                    c && (e = c.bounds,
                    e && s.push(e)));
            ...
            d.x = i(d.x * k) / k,
            d.y = i(d.y * k) / k,
            d.width = j(d.width * k) / k,
            d.height = j(d.height * k) / k,
            d = ib(q, d))),
            d && (a = Ub(m, g, h, k, d),
            f.draw(a, d),
            a.restore()),
            ...
            v && n > 0 && o > 0) {
                ...
                if (c) {
                    var e = c.bounds
                      ...
                      , A = w.height
                      , k = f._zoom;
                    e && !hb(e, w) && (e.x + e.width < x && (f.translateX = -e.x * k),
                    e.x > x + z && (f.translateX = -(e.x + e.width - z) * k),
                    e.y + e.height < y && (f.translateY = -e.y * k),
                    e.y > y + A && (f.translateY = -(e.y + e.height - A) * k))
                }
                delete f._makeVisibleData
            }
            f._invalidateContentRect && (delete f._invalidateContentRect,
            delete f._contentRect)
        }
    }),
    ...
    G(Ee, {
        ...
        setZoomImpl: function(a, b) {
            ...
            a !== c._zoom) {
                ...
                c.translateX = (b.x - d.x) * e - b.x * a,
                c.translateY = (b.y - d.y) * e - b.y * a),
                c._zoom = a,
                c.epc("zoom", e, a)
            }
        }
    ...
    var He = _("qc.widget.graph.Interactor", b, function(a) {
      ...
      , Ie = _("qc.widget.graph.BasicInteractor", He, function(a) {
        ...
        handle_touchstart: function(a) {
            ...
            K(a),
            c.requestFocus(),
            Ma(a) > 1 || d.editing || d.scrolling || c.pannable && !e && Eb(a) && !Fb(a) && (b._tx = c.translateX,
            b._ty = c.translateY,
            b.startDragging(a))
        },
        handle_touchend: function(a) {
        ...
        handleDoubleClick: function(a, b) {
            if (Eb(a)) {
                ...
                d.onDataDoubleClick(b, a),
                c.checkDoubleClickOnNote(a, b) || b.ISubGraph && (d.currentSubGraph = b,
                d.selectionModel.clearSelection())) : (c.emit({
                    kind: "doubleClickBackground",
                    event: a
                }),
                d.onBackgroundDoubleClick(a),
                d.upSubGraph())
            }
        },
        checkDoubleClickOnNote: function(a, b) {
            var c = this
              ...
              , f = d.getDataUI(b)
              , g = f.noteInfo;
            return g && b.s("note.toggleable") && fb(g.hitRect, e) ? (b.s("note.expanded", !b.s("note.expanded")),
            c.emit({
                kind: "toggleNote",
                event: a,
                data: b
      ...
      , Je = _("qc.widget.graph.ScrollBarInteractor", He, function(a) {
        ...
        handle_touchmove: function(a) {
            if (!Ab() && Eb(a)) {
                var b = this
                  ...
                  , d = c.isCloseToVScrollBar(a)
                  , e = c.isCloseToHScrollBar(a);
                b._cp ? b._state || (d ? b._state = "vScroll" : e && (b._state = "hScroll"),
                b._state && (Bb(b, a),
                b.emit({
                    kind: "beginScroll",
                    event: a
        ...
        handle_touchstart: function(a) {
            ...
            Ma(a) > 1 || !c._interactionState.scrolling || (b._cp = xa(a),
            b._tx = c.translateX,
            b._ty = c.translateY)
        },
        handleWindowMouseMove: function(a) {
      ...
      , Ke = _("qc.widget.graph.EditInteractor", He, function(a) {
        ...
        clear: function() {
            var a = this
              , b = a._graphView
              , d = a._node;
            d && (b.getDataUI(d).selectWidthVisible = !0,
            b._dirtyMap[d.uuid] = d,
            a._node = a._edgeRect = a._resizePoints = a._rotationPoint = a._shapePoints = c)
        },
        handle_mousemove: function(a) {
            this.handle_touchmove(a)
        },
        ...
        handleWindowTouchMove: function(a) {
            ...
            if ("anchor" === f)
                ...
                r = l(o + m - p.y, 0),
                n = n + k - q,
                o = o + m - r) : 1 === g ? (q = l(p.x - n, 0),
                r = l(o + m - p.y, 0),
                o = o + m - r) : 2 === g ? (q = l(p.x - n, 0),
                r = l(p.y - o, 0)) : 3 === g && (q = l(n + k - p.x, 0),
                r = l(p.y - o, 0),
                n = n + k - q),
                ...
                e.emitShapeChange()) : "left" === f ? (q = l(n + k - p.x, 0),
                n = n + k - q,
                e.setPosition(ve(e, n + j.x * q, o + j.y * m)),
                e.setSize(q, m)) : "right" === f ? (q = l(p.x - n, 0),
                e.setPosition(ve(e, n + j.x * q, o + j.y * m)),
                e.setSize(q, m)) : "top" === f ? (r = l(o + m - p.y, 0),
                o = o + m - r,
                e.setPosition(ve(e, n + j.x * k, o + j.y * r)),
                e.setSize(k, r)) : "bottom" === f && (r = l(p.y - o, 0),
                e.setPosition(ve(e, n + j.x * k, o + j.y * r)),
                e.setSize(k, r))
        },
        ...
        validate: function() {
            ...
            if (se(j)) {
                if (a._node = j,
                b.getDataUI(j).selectWidthVisible = !1,
                b._dirtyMap[j.uuid] = j,
                a._edgeRect = {
                ...
                var l = j.position;
                if ((!b.anchorEditableFunc || b.anchorEditableFunc(j)) && (f.beginPath(),
                f.arc(l.x * g + h, l.y * g + i, 6, 0, r, !0),
                f.strokeStyle = "#F5F4FF",
                f.lineWidth = 6,
                f.stroke(),
                f.strokeStyle = "#5052F9",
                f.lineWidth = 4,
                f.stroke()),
                !b.rotationEditableFunc || b.rotationEditableFunc(j)) {
                    var m = j.rotation
                      , n = 30;
                    f.strokeStyle = "#8175D5",
                    f.lineWidth = 1,
      ...
      , Le = _("qc.widget.graph.SelectInteractor", He, function(a) {
        ...
        handle_touchstart: function(a) {
            ...
            !(Ma(a) > 1 || d.editing || d.scrolling)) {
                var e = c.getDataAt(a)
                  , f = c.selectionModel;
                e ? Fb(a) ? f.isSelected(e) ? f.removeSelection(e) : f.appendSelection(e) : f.isSelected(e) || (f.selection = e) : Fb(a) || !c.pannable ? Eb(a) && (Fb(a) || f.clearSelection(),
                c.rectSelectable && (b.startDragging(a),
                d.selecting = !0)) : b._pendingCS = xa(a)
            }
        },
        handle_mouseup: function(a) {
            this.handle_touchend(a)
        ...
        handle_touchend: function(a) {
            var b = this
              , c = b._pendingCS;
            c && (ab(c, xa(a)) <= 1 && b._graphView.selectionModel.clearSelection(),
            delete b._pendingCS)
        },
        handleWindowMouseUp: function(a) {
            this.handleWindowTouchEnd(a)
        ...
        handleWindowTouchMove: function(a) {
            ...
            b.intersects() ? (g.border = "",
            g.background = c.rectSelectBackground) : (g.background = "",
            g.border = "1px solid " + c.rectSelectBorderColor)
        },
        intersects: function() {
            var a = this
      ...
      , Me = _("qc.widget.graph.MoveInteractor", He, function(a) {
        ...
        handle_touchstart: function(a) {
            ...
            if (!(Ma(a) > 1 || !Eb(a) || d.editing || d.scrolling)) {
                ...
                e && c.isMovable(e) && (b.startDragging(a),
                d.moving = !0)
            }
        },
        handleWindowMouseUp: function(a) {
        ...
        handleWindowTouchEnd: function(a) {
            var b = this;
            b._lastLogicalPoint && (delete b._graphView._interactionState.moving,
            b._logicalPoint && b.emit({
                kind: "endMove",
                event: a
            }),
            b.clearDragging())
