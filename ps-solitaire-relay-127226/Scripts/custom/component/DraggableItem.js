...
(function (ps) {
    ...
    var DraggableItem = /** @class */ (function (_super) {
        ...
        DraggableItem.prototype.deploty = function () {
            var _a;
            // if (!this.orgParent) {
        ...
        DraggableItem.prototype._onDown = function (target, e) {
            ...
            this.gameObject.switchParent(this.worldObj, this.worldObj.children.length);
            var scale = this.gameObject.scaleX * this.diffS;
            ...
            // this.gameObject.scaleX = this.gameObject.scaleY = this.newS * this.diffS;
            ps.Tween.to(this.gameObject, { scale: scale, }, this.returnAnimDuration, Phaser.Easing.Cubic.Out);
            // }
        ...
        DraggableItem.prototype.dragEnd = function (e) {
            ...
            temp.y -= 50;
            var hitTarget = this.checkHitTargetArea(temp.getWorldPosition());
