...
/**
 * 替换音频数据
 * @param name {string} 音频名字
 * @param audioData {ArrayBuffer} 音频数据
 */
declare function replaceAudioData(name: string, audioData: ArrayBuffer);
 ...
 * 销毁音乐，一般是关闭页面的时候调用
 */
declare function destorySound(): void;

/**
 * 设置音量
 */
declare function setVolume(url: string, volume: number): void;

/**
 * 强制静音 true/false
 */
declare function forceMuted(bool: boolean);