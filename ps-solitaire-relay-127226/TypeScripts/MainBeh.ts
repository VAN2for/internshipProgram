...
let gameEvent = new ps.EventDispatcher();

class MainBeh extends ps.Behaviour {
    public gameEvent = new ps.EventDispatcher();
    /** 场景节点列表 */
    public sceneNodes: qc.Node[] = [];

    public testSolitaire: ps.solitaire;
