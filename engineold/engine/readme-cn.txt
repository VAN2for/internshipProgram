...
PlaySmart引擎是一个免费开源的JavaScript游戏引擎类库，并提供了一站式基于浏览器的HTML5游戏开发工具套件。
PlaySmart文件目录结构
...
/lib                        JavaScript类库目录
    ...
    /qc-core-debug.js       未压缩的开发版引擎核心类库
    /qc-core.js             压缩的发布版核心类库
...
如果您本机已经安装了Node.js，推荐您升级到最新版本，引擎支持的Node.js版本：
...
根据你的操作系统直接双击运行start-mac.command或start-win.bat启动服务，默认会自动打开浏览器访问：http://localhost:5002/project.html，也可通过在引擎解压包所在目录下运行：node ./editorservice/StartService.js 命令实现同样地效果。
